...
public class LibroDiarioDetalle extends TumiDomain{
	...
	public String toString() {
		return "LibroDiarioDetalle [id=" + id + ", intPersEmpresaCuenta="
				+ intPersEmpresaCuenta + ", intContPeriodo=" + intContPeriodo
				...
				+ ", intTipoCambio=" + intTipoCambio + ", bdDebeSoles="
				+ bdDebeSoles + ", bdHaberSoles=" + bdHaberSoles
