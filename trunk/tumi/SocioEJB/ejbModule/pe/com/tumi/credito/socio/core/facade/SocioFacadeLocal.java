...
public interface SocioFacadeLocal {
	...
	/*public List<SocioEstructura> getListaSocEstPorSocioPKActivoTipoSocio(Integer intPersona,Integer intEmpresa, 
			Integer intEstado, Integer intTipoSocio) throws BusinessException;*/
	
	public List<SocioEstructura> getListaXSocioPKActivoTipoSocio(Integer intPersona,Integer intEmpresa, 
			Integer intEstado, Integer intTipoSocio, Integer intNivel, Integer intCodigo) throws BusinessException;
