...
<h:form>
	<h:panelGroup style="background-color:#DEEBF5">
		<h:panelGrid columns="1" id="popupReniecAutCredito">
			<rich:column style="border:none">
				<rich:fileUpload id="upload" addControlLabel="Adjuntar Imagen"
					clearControlLabel="Limpiar" cancelEntryControlLabel="Cancelar"
					uploadControlLabel="Subir Imagen" listHeight="65" listWidth="320"
					fileUploadListener="#{fileUploadControllerServicio.adjuntarReniec}"
		...
		<h:panelGrid columns="2">
			...
			<rich:column style="border:none">
				<a4j:commandButton value="Aceptar" styleClass="btnEstilos"
					action="#{autorizacionPrestamoController.aceptarAdjuntarReniec}"
					oncomplete="Richfaces.hideModalPanel('pAdjuntarReniecAutCredito')"
					reRender="panelReniecAutCredito" />
			</rich:column>
		</h:panelGrid>
	</h:panelGroup>
</h:form>