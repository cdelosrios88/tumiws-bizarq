	   	...
	   	<h:panelGroup>
			...
			<h:panelGroup>
	    		<rich:dataTable
	    			id="tablaDocumentoT"
	    			var="item" 
	                value="#{transferenciaController.listaDocumentoPorAgregar}" 
			  		rowKeyVar="rowKey" 
			  		rows="5" 
			  		sortMode="single" 
			  		width="600px">
					...
					<rich:column width="100px" style="text-align: center;">
			      	...
			      	<rich:column width="80px" style="text-align: center;">
			        	...
			        	<a4j:commandLink 
			    			value="Seleccionar"
							actionListener="#{transferenciaController.seleccionarDocumento}"
							oncomplete="if(#{!transferenciaController.blnNoExisteRequisito}){Richfaces.hideModalPanel('pBuscarDocumentoTransferencia')}"
			...
			<h:panelGroup id="pgMsgErrorT">
	    		<rich:column width="80px" style="text-align: center;">
	    			<h:outputText value="#{transferenciaController.strMensajeError}" styleClass="msgError"/>
	    		</rich:column>
	    	</h:panelGroup>
	   	</h:panelGroup>
	</h:form>