    	...
    	<rich:panel  style="border: 0px solid #17356f;background-color:#DEEBF5;width:670px;">
            <h:panelGrid id="pgBtnDomicilio" border="0" columns="2">
	            <rich:column>
	            	...
	            	disabled="#{domicilioController.formEnableDisableDomicilio}"
            ...
            <h:panelGrid id="pgFormDomicilio" columns="2" border="0">
	            <rich:panel id="pMarco1" style="border:1px; solid #17356f ;width:660px; background-color:#DEEBF5">
					...
					<h:panelGrid columns="6">
			            ...
			            <rich:column>
					  	...
					  	<rich:column style="padding-left:10px">
					  		<h:inputText value="#{domicilioController.beanDomicilio.intNumeroVia}" size="10" style="width:82px" 
					...
					<h:panelGrid columns="6" id="ubicacionPanel">
						...
						<rich:column>
							<h:selectOneMenu id="cboDistrito" value="#{domicilioController.beanDomicilio.intParaUbigeoPkDistrito}" 
								valueChangeListener="#{domicilioController.setCboDistrito}" style="width:150px;">
								<f:selectItem itemValue="0" itemLabel="Seleccionar.."/>
					...
					<h:panelGrid columns="3">
						<rich:column style="width:125px;">
							<h:selectBooleanCheckbox value="#{domicilioController.beanDomicilio.fgCroquis}">
							</h:selectBooleanCheckbox>Croquis
						</rich:column>
						<rich:column>
							<h:selectOneMenu id="cboDireccion" value="#{domicilioController.beanDomicilio.intIdDirUrl}" styleClass="SelectOption" onchange="changeOption()">
								<f:selectItem itemLabel="Seleccione.." itemValue="0"/>
					...
					<a4j:commandButton value="Adjuntar Croquis" 
						...
						actionListener="#{domicilioController.adjuntarCroquis}" reRender="mpFileUpload"/>
					...
					<!--<h:commandLink value="Descargar" action="#{domicilioController.descargarCroquis}"
