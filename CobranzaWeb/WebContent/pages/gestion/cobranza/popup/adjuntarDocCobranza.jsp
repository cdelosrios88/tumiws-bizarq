	    		...
	    		<h:panelGrid columns="1">
		    		<rich:column style="border:none">
        				<rich:fileUpload id="upload"
				             ...
				             listHeight="65" 
				             listWidth="320"
				             fileUploadListener="#{fileUploadController.adjuntarDocCobranza}"
							 maxFilesQuantity="1"
		    	...
		    	<h:panelGrid columns="3">
					...
					<rich:column width="100">
						<a4j:commandButton   value="Aceptar" 
				    		...
				    		action="#{cobranzaController.aceptarAdjuntarDocCobranza}"
				    		reRender="panelDocCobranzaG"
			        		oncomplete="Richfaces.hideModalPanel('pAdjuntarDocCobranza')"/>
				    </rich:column>
				    <rich:column style="border:none">
