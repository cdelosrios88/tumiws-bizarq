	    		...
	    		<h:panelGrid columns="1">
		    		<rich:column style="border:none">
        				<rich:fileUpload id="upload"
				             ...
				             listHeight="65" 
				             listWidth="320"
				             fileUploadListener="#{fileUploadController.adjuntarDocSolicitud}"
							 maxFilesQuantity="1"
		    	...
		    	<h:panelGrid columns="3">
					...
					<rich:column width="100">
						<a4j:commandButton   value="Aceptar" 
				    		...
				    		action="#{solicitudCtaCteController.aceptarAdjuntarDocumento}"
				    		reRender="panelDocCobranzaG,panelDocCobranzaGG,panelDocCobranzaGGG,colContrato"
