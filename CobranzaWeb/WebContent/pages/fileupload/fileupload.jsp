	...
	<f:facet name="header">
		<h:panelGrid>
			<rich:column style="border: none;">
				<h:outputText value="#{fileUploadController.strTitle}"></h:outputText>
			</rich:column>
		</h:panelGrid>
	</f:facet>
	<f:facet name="controls">
		<h:panelGroup>
			<h:graphicImage value="#{fileUploadController.strCloseIconPath}"
	...
	<h:form>
		<h:panelGroup>
			<h:panelGrid border="0" columns="1" style="text-align:left; margin:0 auto">
				<rich:column>
					<h:outputText value="#{fileUploadController.strDescripcion}"></h:outputText>
				</rich:column>
				<rich:column>
					<rich:fileUpload addControlLabel="Adjuntar Archivo"
						clearControlLabel="Limpiar" cancelEntryControlLabel="Cancelar"
						uploadControlLabel="Subir Archivo" listHeight="64" listWidth="320"
						fileUploadListener="#{fileUploadController.adjuntarArchivo}"
			...
			<h:panelGrid border="0" style="margin:0 auto">
				<a4j:commandButton value="Aceptar" styleClass="btnEstilos" onmousedown="#{fileUploadController.strJsFunction}" oncomplete="Richfaces.hideModalPanel('mpFileUpload')"></a4j:commandButton>
			</h:panelGrid>
		</h:panelGroup>
