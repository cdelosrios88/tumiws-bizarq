package pe.com.tumi.message.controller;
...
public class MessageController {
	...
	private 	String 		strFunctionAccept;
	...
	public void clean(){
		...
		strFunctionValidator = "validarMensaje()"; //funcion javascript por defecto para validar
		strFunctionAccept = "acceptMessage()"; //funcion javascript por defecto para el botón Aceptar
	}
	...
	public String getStrFunctionAccept() {
		return strFunctionAccept;
	}
	public void setStrFunctionAccept(String strFunctionAccept) {
		this.strFunctionAccept = strFunctionAccept;
	}	
}
