    	 ...
    	 <h:panelGrid id="pAportaciones">
	    	 <rich:panel style="width: 900px;border:1px solid #17356f;background-color:#DEEBF5;">
	    	 	...
	    	 	<h:panelGrid columns="6">
	    	 		...
	    	 		<rich:column>
	    	 			<h:selectOneMenu>
	    	 				<f:selectItem itemLabel="máximo" itemValue="1"/>
	    	 				<f:selectItem itemLabel="mínimo" itemValue="2"/>
	    	 			</h:selectOneMenu>
	    	 		</rich:column>
	    	 	</h:panelGrid>
	    	 	...
	    	 	<h:panelGrid columns="3">
	    	 		...
	    	 		<rich:column width="250">
	    	 			<h:selectBooleanCheckbox/> Provisión
	    	 		</rich:column>
	    	 		<rich:column>
	    	 	...
	    	 	<h:panelGrid columns="3">
	    	 		<rich:column width="152"/>
	    	 		<rich:column width="250">
	    	 			<h:selectBooleanCheckbox/> Extorno de Provisión
	    	 		</rich:column>
	    	 		<rich:column>
	    	 			<h:commandButton value="Detalle" styleClass="btnEstilos"/>
	    	 		</rich:column>
	    	 	...
	    	 	<h:panelGrid columns="3">
	    	 		<rich:column width="152"/>
	    	 		<rich:column width="250">
	    	 			<h:selectBooleanCheckbox/> Regularización de cuotas
	    	 		</rich:column>
	    	 		<rich:column>
	    	 			<h:commandButton value="Detalle" styleClass="btnEstilos"/>
	    	 		</rich:column>
	    	 	...
	    	 	<h:panelGrid columns="3">
	    	 		<rich:column width="152"/>
	    	 		<rich:column width="250">
	    	 			<h:selectBooleanCheckbox/> Aprobación de Beneficio
	    	 		</rich:column>
	    	 		<rich:column>
	    	 			<h:commandButton value="Detalle" styleClass="btnEstilos"/>
	    	 		</rich:column>
	    	 	...
	    	 	<h:panelGrid columns="3">
	    	 		<rich:column width="152"/>
	    	 		<rich:column width="250">
	    	 			<h:selectBooleanCheckbox/> Anulación o Rechazo del Beneficio
	    	 		</rich:column>
	    	 		<rich:column>
	    	 			<h:commandButton value="Detalle" styleClass="btnEstilos"/>
	    	 		</rich:column>
