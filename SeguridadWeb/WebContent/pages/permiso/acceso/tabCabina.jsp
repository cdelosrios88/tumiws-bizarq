...
<rich:panel style="border: 0px solid #17356f;" styleClass="rich-tabcell-noborder">
         		...
         		<rich:column style="width: 120px;">
					<h:selectOneMenu
						...
						<a4j:support event="onchange" action="#{accesoController.seleccionaTipoUsuario}" 
							reRender="colCajaUsuarioC,colBotonUsuarioC"  />
					</h:selectOneMenu>
                </rich:column>
            	<rich:column  id="colCajaUsuarioC">
         			<h:inputText size="36" 
         				readonly="true" 
         				id="cajaUsuarioFiltroC"
         		...
         		<rich:column  id="colBotonUsuarioC">
         			<a4j:commandButton 
         				style="width: 110px"
					    ...
					    <f:attribute name="caja" value="cajaUsuarioFiltroC"/>
				    </a4j:commandButton>
         		</rich:column>
         	</h:panelGrid>
         	<h:panelGrid columns="4">
            	...
            	<rich:column style="width: 205px">
         		...
         		<rich:column>
         			<a4j:commandButton styleClass="btnEstilos" value="Buscar"
                    	action="#{accesoController.buscar}" reRender="panelTablaAccesosC"/>
         		</rich:column>          	         		
         	</h:panelGrid>
            
            <rich:spacer height="12px"/>           
            
            <h:panelGrid id="panelTablaAccesosC">
	        	<rich:extendedDataTable id="tblAccesosC" 
                    ...
                    <f:facet name="footer">   
							<rich:datascroller for="tblAccesosC" maxPages="20"/>   
					</f:facet>
					<a4j:support event="onRowClick"  
						actionListener="#{accesoController.seleccionarRegistro}"
						reRender="frmAlertaRegistroC,contPanelInferiorC,panelBotonesC"
						oncomplete="if(#{accesoController.mostrarBtnEliminar}){Richfaces.showModalPanel('pAlertaRegistroC')}">
		...
		<rich:panel id="panelMensajeC" style="border: 0px solid #17356f;background-color:#DEEBF5;width:100%">
			<rich:panel
		...
		<rich:panel style="border: 0px solid #17356f;background-color:#DEEBF5;" styleClass="rich-tabcell-noborder"
			...
			<h:panelGrid columns="4">
				<a4j:commandButton value="Nuevo" styleClass="btnEstilos" style="width:90px" 
					actionListener="#{accesoController.habilitarPanelInferior}" reRender="contPanelInferiorC,panelMensajeC,panelBotonesC" />                     
			    <a4j:commandButton value="Grabar" styleClass="btnEstilos" style="width:90px"
			    	action="#{accesoController.grabar}" reRender="contPanelInferiorC,panelMensajeC,panelBotonesC"
			    	disabled="#{!accesoController.habilitarGrabar}"/>       												                 
			    <a4j:commandButton value="Cancelar" styleClass="btnEstilos"style="width:90px"
			    	actionListener="#{accesoController.deshabilitarPanelInferior}" reRender="contPanelInferiorC,panelMensajeC"/>      
			</h:panelGrid>
		</rich:panel>
		        	
		        	
		<rich:panel id="contPanelInferiorC" style="border:0px;">
		    	...
		    	<h:panelGroup id="panelIngresarAcceso">
		        	<h:panelGrid border="0" columns="2">
                     ...
                     <h:panelGrid border="0" columns="3">
                        ...
                        <rich:column >
                   			<h:inputText size="40" id="cajaUsuarioOperaNuevoCabina" readonly="true" 
                     	...
                     	<rich:column>
                    		<a4j:commandButton 
					    		...
					    		reRender="pgListaUsuarios"
					    		styleClass="btnEstilos">
					    		<f:attribute name="caja" value="cajaUsuarioOperaNuevoCabina"/>
				    		</a4j:commandButton>
                     	</rich:column>
                     </h:panelGrid>
							...
							<h:panelGrid columns="2">
				         	...
				         	<h:panelGrid columns="2">
								...
								<rich:column>
									<h:panelGrid columns="2">
										<rich:column>
						         			<h:inputText size="30" id="cajaUsuarioAutorizaNuevoCabina" readonly="true" 
				                   				disabled="#{accesoController.deshabilitarNuevo}"
						         		 ...
						         		 <rich:column  style="width: 60px">
						         			<a4j:commandButton 
									    		...
									    		reRender="pgListaUsuarios"
									    		styleClass="btnEstilos">
									    		<f:attribute name="caja" value="cajaUsuarioAutorizaNuevoCabina"/>
								    		</a4j:commandButton>
						         		</rich:column>
					         		</h:panelGrid>
				                </rich:column>
