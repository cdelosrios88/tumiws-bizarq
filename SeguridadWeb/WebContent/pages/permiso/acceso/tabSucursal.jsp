...
<rich:panel style="border: 0px solid #17356f;" styleClass="rich-tabcell-noborder">
         		...
         		<rich:column style="width: 120px;">
					<h:selectOneMenu
						...
						<a4j:support event="onchange" action="#{accesoController.seleccionaTipoUsuario}" 
							reRender="colCajaUsuarioS,colBotonUsuarioS"  />
					</h:selectOneMenu>
                </rich:column>
            	<rich:column  id="colCajaUsuarioS">
         			<h:inputText size="36" 
         				readonly="true" 
         				id="cajaUsuarioFiltroS"
         		...
         		<rich:column  id="colBotonUsuarioS">
         			<a4j:commandButton 
						style="width: 110px"
					    ...
					    <f:attribute name="caja" value="cajaUsuarioFiltroS"/>
				    </a4j:commandButton>
         		</rich:column>
         	</h:panelGrid>
         	<h:panelGrid columns="4">
            	...
            	<rich:column style="width: 205px">
         		...
         		<rich:column>
         			<a4j:commandButton styleClass="btnEstilos" value="Buscar"
                    	action="#{accesoController.buscar}" reRender="panelTablaAccesosS"/>
         		</rich:column>          	         		
         	</h:panelGrid>
            
            <rich:spacer height="12px"/>           
            
            <h:panelGrid id="panelTablaAccesosS">
	        	<rich:extendedDataTable id="tblAccesosS" 
                    ...
                    <f:facet name="footer">   
							<rich:datascroller for="tblAccesosS" maxPages="20"/>   
					</f:facet>
					<a4j:support event="onRowClick"  
						actionListener="#{accesoController.seleccionarRegistro}"
						reRender="frmAlertaRegistroS,contPanelInferiorS,panelBotonesS"
						oncomplete="if(#{accesoController.mostrarBtnEliminar}){Richfaces.showModalPanel('pAlertaRegistroS')}">
		...
		<rich:panel id="panelMensajeS" style="border: 0px solid #17356f;background-color:#DEEBF5;width:100%">
			<rich:panel
		...
		<rich:panel style="border: 0px solid #17356f;background-color:#DEEBF5;" styleClass="rich-tabcell-noborder"
			...
			<h:panelGrid columns="4">
				<a4j:commandButton value="Nuevo" styleClass="btnEstilos" style="width:90px" 
					actionListener="#{accesoController.habilitarPanelInferior}" reRender="contPanelInferiorS,panelMensajeS,panelBotonesS" />                     
			    <a4j:commandButton value="Grabar" styleClass="btnEstilos" style="width:90px"
			    	action="#{accesoController.grabar}" reRender="contPanelInferiorS,panelMensajeS,panelBotonesS"
			    	disabled="#{!accesoController.habilitarGrabar}"/>       												                 
			    <a4j:commandButton value="Cancelar" styleClass="btnEstilos"style="width:90px"
			    	actionListener="#{accesoController.deshabilitarPanelInferior}" reRender="contPanelInferiorS,panelMensajeS,panelBotonesS"/>      
			</h:panelGrid>
		</rich:panel>
		        	
		
		          	
		<rich:panel id="contPanelInferiorS" style="border:0px;">
		        	...
		        	<h:panelGrid border="0" columns="2">
                        ...
                        <rich:column >
                   			<h:selectOneMenu id="cboEmpresaInf" 
								...
								<tumih:selectItems var="sel" value="#{accesoController.listaEmpresas}" 
									itemValue="#{sel.intIdPersona}" itemLabel="#{sel.strSiglas}"/>
								<a4j:support event="onchange" action="#{accesoController.seleccionarEmpresa}" 
									reRender="colSucursal"  />	
							</h:selectOneMenu>
                     	</rich:column>
                     </h:panelGrid>
                     ...
                     <h:panelGrid border="0" columns="3">
                        ...
                        <rich:column >
                   			<h:inputText size="40" id="cajaUsuarioOperaNuevoSucursal" readonly="true" 
                     	...
                     	<rich:column>
                    		<a4j:commandButton 
					    		...
					    		reRender="pgListaUsuarios"
					    		styleClass="btnEstilos">
					    		<f:attribute name="caja" value="cajaUsuarioOperaNuevoSucursal"/>
				    		</a4j:commandButton>
                     	</rich:column>
                     </h:panelGrid>
			        	...
			        	<rich:column  style="width: 110px">
	         			...
	         			<rich:column id="colSucursal">
							<h:selectOneMenu id="cboSucursal" 
								style="width: 210px;"
								disabled="#{accesoController.deshabilitarNuevo}"
								value="#{accesoController.accesoEspecialNuevo.intIdSucursal}">
								<tumih:selectItems var="sel" value="#{accesoController.listaSucursales}" 
							...
							<h:panelGrid columns="2">
				         	...
				         	<h:panelGrid columns="2">
								...
								<rich:column>
									<h:panelGrid columns="2">
										<rich:column>
						         			<h:inputText size="30" id="cajaUsuarioAutorizaNuevoSucursal" readonly="true" 
				                   				disabled="#{accesoController.deshabilitarNuevo}"
						         		 ...
						         		 <rich:column  style="width: 60px">
						         			<a4j:commandButton 
									    		...
									    		reRender="pgListaUsuarios"
									    		styleClass="btnEstilos">
									    		<f:attribute name="caja" value="cajaUsuarioAutorizaNuevoSucursal"/>
								    		</a4j:commandButton>
						         		</rich:column>
					         		</h:panelGrid>
				                </rich:column>
