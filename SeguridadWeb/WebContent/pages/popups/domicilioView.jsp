    	...
    	<rich:panel  style="border: 0px solid #17356f;background-color:#DEEBF5;width:670px;">
            <h:panelGrid id="pgBtnDomicilio" border="0" columns="2">
	            <rich:column>
	            	...
	            	disabled="true" reRender="#{domicilioController.strIdModalDomicilio},#{domicilioController.strIdListDomicilio}"/>
	            </rich:column>
	            <rich:column style="border:none"><h:commandButton value="Cancelar" styleClass="btnEstilos" disabled="true"/></rich:column>
            </h:panelGrid>
            ...
            <h:panelGrid id="pgFormDomicilio" columns="2" border="0">
	            <rich:panel id="pMarco1" style="border:1px; solid #17356f ;width:660px; background-color:#DEEBF5">
					...
					<h:panelGrid columns="4">
						...
						<rich:column>
							<h:inputText id="nombreVia" label="nombreVia" value="#{domicilioController.beanDomicilio.strNombreVia}" disabled="true" size="40"/>
						</rich:column>
					</h:panelGrid>
					...
					<h:panelGrid columns="6">
			            ...
			            <rich:column>
					  	...
					  	<rich:column style="padding-left:10px;">
					  		<h:inputText value="#{domicilioController.beanDomicilio.intNumeroVia}" size="10" style="width:82px" onkeypress="return soloNumeros(event);" disabled="true" maxlength="5"/>
						</rich:column>
						<rich:column style="padding-left:10px;">
							<h:outputText value="Interior:"/>
						</rich:column>
						<rich:column style="padding-left:10px;">
							<h:inputText value="#{domicilioController.beanDomicilio.strInterior}" disabled="true" size="10"/>
						</rich:column>
					</h:panelGrid>
					...
					<h:panelGrid columns="4" id="domicilioPanel">
						<rich:column style="width: 125px; border:none;">
					  	...
					  	<rich:column>
						  	<h:selectOneMenu id="cboTipoZona" value="#{domicilioController.beanDomicilio.intTipoZonaCod}" disabled="true">
								<f:selectItem itemLabel="Seleccione.." itemValue="0"/>
					...
					<h:panelGrid columns="6" id="ubicacionPanel">
						...
						<rich:column>
							<h:selectOneMenu id="cboDistrito" value="#{domicilioController.beanDomicilio.intParaUbigeoPkDistrito}" style="width:150px;" disabled="true">
								<f:selectItem itemValue="0" itemLabel="Seleccionar.."/>
					...
					<h:panelGrid columns="3">
						...
						<rich:column>
							<h:selectOneMenu value="#{domicilioController.beanDomicilio.strDirUrl}" disabled="true">
								<f:selectItem itemLabel="Seleccione.." itemValue="0"/>
					...
					<%--
					<h:panelGrid id="cboPnlUpload" columns="1">
			            <div align="center">
       						<h:graphicImage value="#{domicilioController.beanDomicilio.strRutaCroquis}" width="200px" height="80px"/>
       					</div>
			       	 </h:panelGrid>
			        --%>
