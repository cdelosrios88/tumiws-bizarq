...
import pe.com.tumi.report.business.MakerEstadoCuentaTabDetalle;

public class ReporterEstCtaTabDetalle {
	...
	public void executeReport(String strNombreReporte, HashMap<String,Object> parameters){
		...
		try {
			...
			//Tab Detalle
			MakerEstadoCuentaTabDetalle makerTabDetalle = new MakerEstadoCuentaTabDetalle();
			List<DataBeanEstadoCuentaDetalleMovimiento> dataBeanList = makerTabDetalle.getDataBeanList();
