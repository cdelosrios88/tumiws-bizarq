...
public class CarteraCreditoManualGen extends TumiDomain {
	...
	public void setIntGenerado(Integer intGenerado) {
		this.intGenerado = intGenerado;
	}

	public Integer getIntGenerado() {
		return intGenerado;
	}
