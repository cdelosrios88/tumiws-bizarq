   	...
   	<rich:panel styleClass="rich-tabcell-noborder" style="border:1px solid #17356f;">
		...
		<table width="100%" border="0" align="center">
			<tr>
	            ...
	            <td width="150">
	            	<h:selectOneMenu id="cboSucursal" value="#{fondoSepelioController.intIdSucursal}"
	            		onchange="getSubSucursal(#{applicationScope.Constante.ONCHANGE_VALUE})"
	            		style="width:140px">
						<f:selectItem itemLabel="Seleccione.." itemValue="0" />
						<tumih:selectItems var="sel" value="#{fondoSepelioController.listaSucursal}"
	            ...
	            <td>
	            	<h:selectOneMenu id="cboSubSucursal" style="width: 110px;"
			            value="#{fondoSepelioController.intIdSubSucursal}">
						<f:selectItem itemLabel="Seleccione.." itemValue="0"/>
						<tumih:selectItems var="sel" value="#{fondoSepelioController.listaSubSucursal}"
							itemValue="#{sel.id.intIdSubSucursal}" itemLabel="#{sel.strDescripcion}" propertySort="strDescripcion"/>
					</h:selectOneMenu>
				</td>
				<td>
					<h:selectOneMenu id="idTipoSolicitud" value="#{fondoSepelioController.intIdTipoFiltro}">
				...
				<td>
					<h:inputText id="idDescFiltro" value="#{fondoSepelioController.strTipoFiltro}" size="60"/>
	            </td>
	        </tr>
		</table>
		<br/>
		<table>
			<tr>
	            ...
	            <td>
	            	<h:selectOneMenu id="idTipoVinculo" value="#{fondoSepelioController.intTipoTitular}">
						<f:selectItem itemLabel="Seleccione.." itemValue="0" />
						<tumih:selectItems var="sel" value="#{fondoSepelioController.listaTipoTitular}"
	            ...
	            <td>
	            	<h:selectOneMenu id="idEstadoSolicitud" value="#{fondoSepelioController.intEstadoSolicitud}">
						<f:selectItem itemLabel="Seleccione.." itemValue="0"/>
						<tumih:selectItems var="sel" value="#{fondoSepelioController.listaEstadoSolicitud}"
							itemValue="#{sel.intIdDetalle}" itemLabel="#{sel.strDescripcion}"
	            ...
	            <td>
	            	<h:selectOneMenu id="idEstadoPago" value="#{fondoSepelioController.intEstadoPago}">
						<f:selectItem itemLabel="Seleccione.." itemValue="0"/>
	            ...
	            <td>
	            	<rich:calendar id="dtSolicitudDesde" datePattern="dd/MM/yyyy"
						value="#{fondoSepelioController.dtFechaSolicitudDesde}"  
						inputSize="10" 
						showApplyButton="true"/>
	            </td>
	            <td>
	            	<rich:calendar id="dtSolicitudHasta" datePattern="dd/MM/yyyy"
						value="#{fondoSepelioController.dtFechaSolicitudHasta}"  
						inputSize="10" 
						showApplyButton="true"/>
	            </td>
	            <td>
	            	<a4j:commandButton  value="Buscar" 
  						action="#{fondoSepelioController.buscar}" 
  						styleClass="btnEstilos" ajaxSingle="true"
  						process="cboSucursal,cboSubSucursal,idTipoSolicitud,idDescFiltro,idTipoVinculo,
  								 idEstadoSolicitud,idEstadoPago,dtSolicitudDesde,dtSolicitudHasta"
  						reRender="dtFondoSepelio"/>
  					<h:commandButton  value="Reporte" 
  						action="#{fondoSepelioController.imprimirFondoSepelio}" 
				...
				<tr>
					<td align="center">
		        		<a4j:outputPanel id="oppObjSqlSc" ajaxRendered="true">
							<rich:dataTable id="dtFondoSepelio" styleClass="dataTable1"
								value="#{fondoSepelioController.listaFondoSepelio}"
								rendered="#{not empty fondoSepelioController.listaFondoSepelio}"
		                   		rows="5" 
		                   		var="item" rowKeyVar="rowKey" width="950px">
									...
									<rich:column style="text-align: center">
										<h:outputText value="#{item.strFechaFallecimiento}"/>
									</rich:column>
									<rich:column style="text-align: center">
		                            ...
		                            <f:facet name="footer">
		                            	<rich:datascroller for="dtFondoSepelio" maxPages="10"/>
		                            </f:facet>
			                </rich:dataTable>
						</a4j:outputPanel>
					</td>
