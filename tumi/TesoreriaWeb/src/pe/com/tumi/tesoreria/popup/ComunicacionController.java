...
public class ComunicacionController {
	...
	private 	List<Comunicacion>			beanListComuniProveedor = null;
	...
	public ComunicacionController(){
		...
		listComuniContactoNatu = new ArrayList<Comunicacion>();
	...
	public void showComuniPerProveedor(ActionEvent event){
		log.info("--------------------Debugging ComunicacionController.agregarComunicacion-------------------");
		limpiarFormComunicacion();
		setStrCallingFormId("frmPerJuriProveedor");
      ...
      */if(com.getIntTipoComunicacionCod()!=null && !com.getIntTipoComunicacionCod().equals(0)){
      ...
      if(getStrCallingFormId()!=null && getStrCallingFormId().equals(strFormIdJuriConve)){
    	  ...
    	  if(getListComuniContactoNatu()!=null){
        	  arrCom = (ArrayList) getListComuniContactoNatu();
          }
    	  arrCom.add(com);
    	  ...
    	  if(getListComuniSocioNatu()!=null){
        	  arrCom = (ArrayList) getListComuniSocioNatu();
          }
    	  arrCom.add(com);
    	  ...
    	  if(getListComuniSocioNatuEmp()!=null){
        	  arrCom = (ArrayList) getListComuniSocioNatuEmp();
          }
    	  arrCom.add(com);
    	  ...
    	  if(getListComuniBeneficiario()!=null){
        	  arrCom = (ArrayList) getListComuniBeneficiario();
          }
    	  arrCom.add(com);
    	  
    	  setListComuniBeneficiario(arrCom);
	  }else if(getStrCallingFormId()!=null && getStrCallingFormId().equals(strFormIdJuriProveedor)){
		  /*log.info("--form proveedor");
		  log.info("intTipoComunicacionCod:"+com.getIntTipoComunicacionCod());*/
    	  beanListComuniProveedor.add(com);
	...
	public void viewComunicacionProveedor(ActionEvent event){
		log.info("------------------Debugging ComunicacionController.viewComunicacionJuridica-------------------");
	    String rowKey = getRequestParameter("rowKeyComunicacionProveedor");
		log.info("rowKeyComunicacionJuridica = "+ rowKey);
		
		viewComunicacion(beanListComuniProveedor, rowKey);
	}
	...
	*/
	...
	public void quitarComunicacionProveedor(ActionEvent event){		
		log.info("-------------------------------------Debugging quitarComunicacionProveedor-------------------------------------");
		String rowKey = getRequestParameter("rowKeyComunicacionProveedor");
		
		quitarComunicacion(beanListComuniProveedor, rowKey);
		log.info("beanListComuniPerJuri.size: "+beanListComuniProveedor.size());
	}
	...
	public List<Comunicacion> getBeanListComuniProveedor() {
		return beanListComuniProveedor;
	}
	public void setBeanListComuniProveedor(
			List<Comunicacion> beanListComuniProveedor) {
		this.beanListComuniProveedor = beanListComuniProveedor;
	}
