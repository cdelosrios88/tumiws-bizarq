...
<rich:modalPanel id="pBuscarRequisicionContrato" width="650" height="270"
    ...
    <f:facet name="controls">
        <h:panelGroup>
           <h:graphicImage value="/images/icons/remove_20.png" styleClass="hidelink">
           		<rich:componentControl for="pBuscarRequisicionContrato" operation="hide" event="onclick"/>
           </h:graphicImage>
       </h:panelGroup>
    </f:facet>
   	<h:form>
	   	<h:panelGroup>
	   		...
	   		<h:panelGroup>
	    		<rich:dataTable
	    			var="item"
	                value="#{contratoController.listaRequisicion}"
			  		rowKeyVar="rowKey"
			  		rows="5"
			  		sortMode="single" 
			  		width="600px">
					...
					<rich:column width="100" style="text-align: center;">
			        	...
			        	<a4j:commandLink 
			    			value="Seleccionar"
							actionListener="#{contratoController.seleccionarRequisicion}"
							oncomplete="Richfaces.hideModalPanel('pBuscarRequisicionContrato')"
							reRender="panelRequisicionC">
