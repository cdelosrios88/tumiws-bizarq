...
<!-- Fecha     : 11/06/2012               -->
	...
	<h:form id="frmMantCuenta">
		<rich:extendedDataTable id="edtAportacion" value="#{convenioController.listaMantCtaComp}" 
		...
		<a4j:commandButton id="btnSelectMantCuenta" value="Seleccionar" styleClass="btnEstilos" actionListener="#{convenioController.getListaMantCuenta}" reRender="pgListMantCuenta"
		oncomplete="Richfaces.hideModalPanel('panelMantCuenta')"/>
	</h:form>