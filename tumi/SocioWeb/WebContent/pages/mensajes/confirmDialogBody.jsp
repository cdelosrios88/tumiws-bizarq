	...
	<h:form>
		<rich:panel style="border: 0px solid #17356f;background-color:#DEEBF5">
			...
			<h:panelGrid border="0" style="margin:0 auto; width: 100%" columns="2">
				<a4j:commandButton value="#{messageController.strAcceptBtn}" styleClass="btnEstilos" style="color:#000000" rendered="#{messageController.blnAccepted}"
								onmousedown="acceptMessage()" onclick="Richfaces.hideModalPanel('mpConfirmMessage')" onmouseup="#{messageController.strFunctionValidator}">
				</a4j:commandButton>
				<a4j:commandButton value="#{messageController.strCancelBtn}" styleClass="btnEstilos" style="color:#000000" rendered="#{messageController.blnAccepted}"
