...
<!-- Modulo    : Servicio    						-->
<!-- Prototipo : Solicitud Presta Tumi - View		-->
<!-- 			 Utilizado en opcion Ver			-->
<!-- Fecha     : 30/11/2013               			-->
		...
		<h:panelGrid id="pgRequisitos" columns="5">
			...
			<rich:column>
				<a4j:commandButton value="Evaluación" actionListener="#{solicitudEspecialController.evaluarPrestamo}" styleClass="btnEstilos1" 
					disabled="true" reRender="pgSolicCreditoEspecial,pgRequisitos,pgEvaluacion,pgPrestamo1,pgPrestamo2,pgCondiciones,pgMsgErrorEvaluacion,pgListDocAdjuntos,pgOperacion,idMontoSolicitado"/>
			</rich:column>
			<rich:column>
			...
			<rich:column>
				<a4j:commandButton value="Imprimir" styleClass="btnEstilos" disabled="true"/>
			</rich:column>
		</h:panelGrid>
			                    ...
			                    <h:panelGrid columns="2">
			                        ...
			                        <rich:column>
			                        	<a4j:commandButton value="Adjuntar Documento" rendered="#{itemRequisitos.detalle.intOpcionAdjunta==1}"
			                        		actionListener="#{solicitudEspecialController.adjuntarDocumento}" reRender="mpFileUpload"
			                        		oncomplete="Richfaces.showModalPanel('mpFileUpload')" styleClass="btnEstilos1"
			                        		disabled="true"
			                        		reRender="pgSolicCreditoEspecial,mpFileUpload, pgListDocAdjuntos,pgEvaluacion,colImgDocAdjunto">
