	...
	<a4j:region>
    	...
    	<rich:panel style="border:0px solid #17356f;background-color:#DEEBF5;width:920px;">
    		...
    		<h:panelGrid columns="3">
    			<rich:column>
    				<a4j:commandButton id="btnCapacidadPagoCas" value="Grabar" actionListener="#{capacidadPagoController.grabarCapacidadCredito}" 
    			...
    			<h:panelGrid id="pgListCapacidadDscto" columns="2">
    				...
    				<rich:column>
	    				<rich:dataTable var="item" rowKeyVar="rowKey" sortMode="single" width="300px"
	    					...
	    					<rich:column>
	    						<a4j:commandLink id="lnkDeleteCapacDscto" styleClass="no-decor" reRender="pgListCapacidadDscto,pgDsctosVarios,pgTotalEntidades,pgBaseTotYDsctos,pgCapacPagoCas"
    			...
    			<h:panelGrid columns="1">
    				<rich:column>
    					<a4j:commandButton value="Calcular" actionListener="#{capacidadPagoController.calcularCapacidadPago}" styleClass="btnEstilos" 
    							reRender="pgBaseTotYDsctos,pgTotalEntidades,pgCapacPagoCas,pgDsctosVarios,pgMsgErrorCapacidad,btnCapacidadPagoCas" />
    				</rich:column>
    			</h:panelGrid>
