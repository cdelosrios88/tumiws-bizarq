	...
	<rich:panel rendered="#{solicitudPrestamoController.formSolicitudPrestamoRendered}" style="width:960px;border:1px solid #17356f;background-color:#DEEBF5;">
		...
		<h:panelGroup id="pgDatosSocio" rendered="#{solicitudPrestamoController.blnDatosSocio}" layout="block">
			...
			<h:panelGrid id="pgMsgErrorEvaluacion">
				...
				<h:outputText value="#{solicitudPrestamoController.msgTxtEdadLimite}" styleClass="msgError"/>
				<h:outputText value="#{solicitudPrestamoController.strMensajeErrorTopeOperacion}" styleClass="msgError"/>
			</h:panelGrid>
			...
			<h:panelGrid id="pgRequisitos" columns="10">
				...
				<rich:column>
					<a4j:commandButton value="Evaluación" actionListener="#{solicitudPrestamoController.evaluarPrestamo}" styleClass="btnEstilos1" 
			...
			<h:panelGrid id="pgEvaluacion" rendered="#{solicitudPrestamoController.blnEvaluacionCredito}">
				<h:panelGrid id="pgPrestamo1" columns="11">
					<rich:column width="120px">
						<h:outputText value="Tipo de Préstamo" styleClass="estiloLetra1"/>
					</rich:column>
					<rich:column>
						<h:outputText value=":"/>
					</rich:column>
				...
				<h:panelGrid columns="6">
					...
					<rich:column>
						<h:inputText value="#{solicitudPrestamoController.bdTotalCuotaPrestamo}" readonly="true"/>
					</rich:column>
					<rich:column width="120px">
				...
				<h:panelGrid columns="3">
					...
					<rich:column>
						<a4j:commandButton value="Agregar" 
							action="#{solicitudPrestamoController.limpiarGarante}"
							oncomplete="#{rich:component('mpGarantesSolidarios')}.show()"
				...
				<h:panelGrid columns="4">
					...
					<rich:column>
						<h:inputTextarea value="#{solicitudPrestamoController.beanExpedienteCredito.strObservacion}" 
								cols="100" rows="3" disabled="#{solicitudPrestamoController.blnTxtObservacionesPrestamo}" />
					</rich:column>
					<rich:column>
				...
				<a4j:outputPanel id="opAdjuntarDocumento">
					<h:panelGrid id="pgListDocAdjuntos" columns="3">
						...
						<!-- Autor: jchavez / Tarea: Modificación / Fecha: 26.08.2014 / -->
						<rich:column style="border:1px solid #17356f; background-color:#DEEBF5">
							
							<h:panelGrid id="pgAdjuntarDocumento">
					                    ...
					                    <h:panelGrid columns="2">
					                        ...
					                        <rich:column>
					                        	...
					                        	<a4j:commandButton 
					                        		...
					                        		actionListener="#{solicitudPrestamoController.adjuntarDocumento}" 						
					                        		oncomplete="Richfaces.showModalPanel('mpAdjuntarDocSolicitudPrestamo')" 
					                        		styleClass="btnEstilos1"
					                        		disabled="#{solicitudPrestamoController.blnBtnAddRequisito}"
					                        		reRender="mpAdjuntarDocSolicitudPrestamo">
					                        ...
					                        <rich:column id="colImgDocAdjunto" width="142" style="border: solid 1px silver; height:122px; padding:0px" rendered="#{itemRequisitos.detalle.intOpcionAdjunta==1}">
												<a4j:mediaOutput element="img" mimeType="#{myFile.mime}" rendered="#{not empty itemRequisitos.fileDocAdjunto}"
