   			...
   			<rich:panel style="width: 880px;border:1px solid #17356f;background-color:#DEEBF5;">
   				...
   				<rich:panel rendered="#{solicitudPrestamoController.blnDatosGarante}" style="width: 860px;border:1px solid #17356f;background-color:#DEEBF5;">
			         ...
			         <h:panelGrid columns="7">
		          		 ...
		          		 <rich:column>
							<h:inputText value="#{solicitudPrestamoController.intNroPersGarantizadas}" size="10" disabled="true"/>
						 </rich:column>		          
						 <rich:column  width="110px;">
		          		 	<h:outputText value="Saldo Aportes: S/."/>
		          		 </rich:column>
		          		 <rich:column>
							<h:inputText value="#{solicitudPrestamoController.bdMontoAporteGaranteSolidario}" size="15" disabled="true">
