	...
	<script language="JavaScript" src="/js/main.js"  type="text/javascript">
		...
		<rich:panel style="border: 0px solid #17356f;background-color:#DEEBF5;">
	        ...
	        <h:panelGrid columns="2">
	         	<rich:column>
	         		<a4j:commandButton value="Seleccionar" actionListener="#{socioEstrucController.seleccionarEntidad}" 
						...
						oncomplete="Richfaces.hideModalPanel('mpSocioEstructura')" styleClass="btnEstilos"/>
	         	</rich:column>
	         	<rich:column>
