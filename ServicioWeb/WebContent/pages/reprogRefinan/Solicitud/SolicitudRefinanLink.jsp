...
<h:panelGroup id="pgSolicitudRefinanLink">
	...
	<h:panelGrid columns="4" styleClass="tableCellBorder4">
		<rich:column width="120px">
			<h:outputText value="Nombre Completo xxx: " styleClass="estiloLetra1"></h:outputText>
		</rich:column>
		<rich:column>
	...
	<h:panelGrid columns="4"  styleClass="tableCellBorder4">
		...
		<rich:column width="150px">
			...
			actionListener="#{solicitudRefinanController.evaluarRefinanciamiento}" disabled="true"
		...
		<rich:column width="150px">
			<a4j:commandButton style="width: 90%" value="Cronograma" oncomplete="#{rich:component('mpCronogramaRefinanciamiento')}.show()"
				styleClass="btnEstilos" reRender="frmCronogramaRefinan" disabled="false">
			</a4j:commandButton>
		</rich:column>
		
		<rich:column width="150px">
			<a4j:commandButton style="width: 90%" value="Imprimir" styleClass="btnEstilos1" disabled="true"
				style="width: 90%" />
		</rich:column>
	</h:panelGrid>
	...
	<h:panelGroup id="pgPostEvaluacionRef" rendered="#{solicitudRefinanController.blnPostEvaluacion}"  styleClass="tableCellBorder4">
		<h:panelGrid columns="8" styleClass="tableCellBorder4">
			<rich:columnGroup>
				...
				<rich:column width="100px">
					<h:inputText size="10" value="#{solicitudRefinanController.intNroCuotas}" readonly="true"
							...
							var="itemRequisitos" columns="2" width="710px" border="0">
								<rich:panel>
									<h:panelGrid columns="2">
										...
										<rich:column>
										<a4j:commandButton value="Adjuntar Documento" disabled="true"
		...
		<h:panelGrid columns="4" styleClass="tableCellBorder4">
			<rich:columnGroup>
				...
				<rich:column width="800px">
					<h:selectOneMenu style="width:190px" value="#{solicitudRefinanController.intMotivoRefinanciamiento}" disabled="true" >
