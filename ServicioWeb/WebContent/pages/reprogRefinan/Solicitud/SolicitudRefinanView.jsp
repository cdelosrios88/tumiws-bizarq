...
<h:panelGroup id="pgSolicitudRefinanView">
	...
	<h:panelGrid columns="2" styleClass="tableCellBorder4">
		<rich:columnGroup>
			...
			<rich:column>
				<a4j:commandButton value="Agregar" styleClass="btnEstilos"  disabled="true"		
	...
	<h:panelGrid columns="4"  styleClass="tableCellBorder4">
		...
		<rich:column width="150px">
			<a4j:commandButton style="width: 90%" value="Imprimir" styleClass="btnEstilos1" disabled="false"
				style="width: 90%" />
		</rich:column>
	</h:panelGrid>
