...
<h:panelGroup id="pgSolicitudActividad">
	...
	<h:panelGrid columns="4" styleClass="tableCellBorder4" id="pgTipoActividad">
			...
			<rich:column width="110px">
				<h:inputText value="#{solicitudActividadController.strDescripcionTipoActividad }" readonly="true" rendered="#{solicitudActividadController.blnMostrarDescripciones}"/>
				<h:selectOneMenu style="width:190px" value="#{solicitudActividadController.intTipoActividad}"
								onchange="cargarComboSubActividad(#{applicationScope.Constante.ONCHANGE_VALUE})"
								rendered="#{!solicitudActividadController.blnMostrarDescripciones}">
				...
				<h:inputText value="#{solicitudActividadController.strDescripcionTipoSubActividad }" readonly="true" rendered="#{solicitudActividadController.blnMostrarDescripciones}"/>
				<h:selectOneMenu id="cboSubActividad" style="width:190px" value="#{solicitudActividadController.intTipoSubActividad}"
								rendered="#{!solicitudActividadController.blnMostrarDescripciones}">
						<f:selectItem itemValue="0" itemLabel="Seleccione.."/>
						<tumih:selectItems var="sel" value="#{solicitudActividadController.listaTiposSubActividad}"
	...
	<h:panelGrid id="pgMontoACancelar" columns="4" styleClass="tableCellBorder4" rendered="#{solicitudActividadController.blnTipoDeSolicitud}">
			...
			<rich:column>
				<h:inputText value="#{solicitudActividadController.strMontoACancelar}"  readonly="#{solicitudActividadController.blnMostrarDescripciones}"
							...
							<h:panelGrid columns="2">
									...
									<!--<rich:column id="colImgDocAdjunto" width="142" style="border: solid 1px silver; height:122px; padding:0px" rendered="#{itemRequisitos.detalle.intOpcionAdjunta==1}">
											<a4j:mediaOutput element="img" mimeType="image/jpeg" rendered="#{not empty itemRequisitos.fileDocAdjunto}"
												createContent="#{solicitudActividadController.paintImage}" value="#{itemRequisitos.fileDocAdjunto}"
	...
	<h:panelGrid>
		...
		<h:panelGroup id="pgDatosSolicitudCompleta">
			...
			<h:panelGrid columns="6">
				...
				<rich:column>
					<a4j:commandButton id="btnCronograma" value="Cronograma" oncomplete="#{rich:component('mpCronogramaActividad')}.show()"
										styleClass="btnEstilos" reRender="frmCronogramaActividad" disabled="#{solicitudActividadController.blnCronograma}" >
    	 			</a4j:commandButton>
				</rich:column>
			...
			<h:panelGrid columns="4">
				...
				<rich:column>
					<h:selectOneMenu value="#{solicitudActividadController.beanExpedienteCredito.intParaFinalidadCod}">
