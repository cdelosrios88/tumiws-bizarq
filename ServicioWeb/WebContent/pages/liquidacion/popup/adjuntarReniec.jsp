...
<h:form>
	<h:panelGroup style="background-color:#DEEBF5">
		<h:panelGrid columns="1" id="popupReniec">
		...
		<h:panelGrid columns="2">
			...
			<rich:column style="border:none">
				<a4j:commandButton value="Aceptar" styleClass="btnEstilos"
					action="#{autorizacionLiquidacionController.aceptarAdjuntarReniecAut}"
					oncomplete="Richfaces.hideModalPanel('pAdjuntarReniecAutLiq')"
