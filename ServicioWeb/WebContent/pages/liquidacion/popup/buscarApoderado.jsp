	...
	<h:form id="frmBuscarApoderado">
	   	<h:panelGroup layout="block">
	    		...
	    		<rich:column width="50">
           		...
           		<rich:column width="250">
           			<h:inputText size="40" onkeydown="return validarNumDocIdentidad(this,event,8)"
           				value="#{giroLiquidacionController.strDNIApoderadoFiltro}"/>
           		</rich:column>
           		<rich:column>
           			<a4j:commandButton styleClass="btnEstilos"
                		value="Buscar" 
                		reRender="tablaPersona"
                    	action="#{giroLiquidacionController.buscarPersonaApoderado}" 
                    	style="width:100px"/>
           		</rich:column>
	    	</h:panelGrid>
			...
			<h:panelGroup id="tablaPersona">
	    		<rich:dataTable
	    			var="item" 
	                value="#{giroLiquidacionController.listaPersonaApoderado}" 
			  		rowKeyVar="rowKey" 
			  		rows="5"
			  		sortMode="single"
			  		width="500px">
					...
					<rich:column width="100px" style="text-align: center;">
			        	...
			        	<a4j:commandLink
			    			value="Seleccionar"
							actionListener="#{giroLiquidacionController.seleccionarPersonaApoderado}"
