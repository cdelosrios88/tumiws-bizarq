...
<h:panelGroup id="pgSolicitudLiquidacion">
		...
		<h:panelGrid style="width: 100%; text-align: center">
			<rich:column>
				<rich:panel id="pgMsgErrorCuenta" style="border: 0px solid #17356f;background-color:#DEEBF5;" 
					rendered="#{solicitudLiquidacionController.blnBloquearXCuenta}" style="text-align: center">
					<h:outputText value="#{solicitudLiquidacionController.strMensajeValidacionCuenta}" styleClass="msgError4" style="text-align: center"/>
				</rich:panel>
			</rich:column>
		</h:panelGrid>
	...
	<h:panelGrid id="pgMsgErrorSolLiq">
		...
		<h:outputText value="#{solicitudLiquidacionController.strMsgTxtCondiciones}" styleClass="msgError" />	
		<h:outputText value="#{solicitudLiquidacionController.strMsgTxtSubOperacion}" styleClass="msgError" />
		<h:outputText value="#{solicitudLiquidacionController.strMsgTxtFechaRenuncia}" styleClass="msgError" />
		<h:outputText value="#{solicitudLiquidacionController.strMsgTxtFechaRecepcion}" styleClass="msgError" />
		<h:outputText value="#{solicitudLiquidacionController.strMsgTxtFechaProgramacion}" 	styleClass="msgError" />
		<h:outputText value="#{solicitudLiquidacionController.strMsgTxtSumaPorcentaje}" styleClass="msgError" />
		<h:outputText value="#{solicitudLiquidacionController.strMsgTxtMontoBrutoLiquidacion}" styleClass="msgError" />
		<h:outputText value="#{solicitudLiquidacionController.strMsgTxtObservacion}" styleClass="msgError" />
		<h:outputText value="#{solicitudLiquidacionController.strMsgTxtGrabar}" styleClass="msgError" />
		<h:outputText value="#{solicitudLiquidacionController.strMsgTxttPeriodoUltimoDescuento}" styleClass="msgError" />
		<h:outputText value="#{solicitudLiquidacionController.strMsgTxtTieneBeneficiarios}" styleClass="msgError" />
		<h:outputText value="#{solicitudLiquidacionController.strMsgTxtParaMotivoRenuncia}" styleClass="msgError" />
	</h:panelGrid>
	...
	<h:panelGrid columns="3">
		...
		<rich:column width="150px">
			<a4j:commandButton value="Evaluación" styleClass="btnEstilos1"
				...
				reRender="pgPostEvaluacionLiquidacion, pgSolicitudLiquidacion, pgListCondiciones, 
						pgListDocAdjuntosLiquidacion, pgDatosSolicitudCompleta,pgMsgErrorSolLiq,cgTipoLiquidacion,
						mpCondicionSinDeudaPendiente, mpCondicionSinGaranteDeudores" />
		</rich:column>
		<rich:column width="150px">
								...
								<rich:column width="420px">
				 					<rich:dataList value="#{solicitudLiquidacionController.lstMsgCondicionSinGarantesDeudores}" var="item">
										<h:panelGrid columns="1">
											<h:outputText value="#{item.strDescripcion}" styleClass="msgError2" />
						            	</h:panelGrid>
									</rich:dataList>								
								</rich:column>
							</h:panelGrid>
							...
							<h:panelGrid columns="2">
								...
								<rich:column>
									<a4j:commandButton value="Adjuntar Documento"
										...
										reRender="mpFileUpload, pgListDocAdjuntosLiquidacion">
	...
	<h:panelGrid columns="3">
		...
		<rich:column width="150px" rendered="#{solicitudLiquidacionController.blnMostrarObjeto}">
			<a4j:commandButton value="ReCalcular" styleClass="btnEstilos1"
				...
				actionListener="#{solicitudLiquidacionController.reCalcularMontosGrillaBeneficiarios}"
				reRender="pgLitstaBeneficiariosLiquidacion,txtValidacionBeneficario"
				/>
		</rich:column>
	</h:panelGrid>
