...
public static String convertNumberToLetter(String number)
        throws NumberFormatException {
    return convertNumberToLetter(Double.parseDouble(number.replace("s/", "").replace(",", "")),number);
}
 ...
 */
public static String convertNumberToLetter(double doubleNumber,String numeroCompleto)
        throws NumberFormatException {
    ...
    String[] aux =numeroCompleto.split("\\.");
    if(aux.length>1){
    	converted.append("CON "+aux[1]+"/100 NUEVOS SOLES");
    }else{
    	converted.append("CON 00/100 NUEVOS SOLES");
    }
    //converted.append(" CON "+ splitNumber[1]+"/100 NUEVOS SOLES");
