...
public class EstadoPrevision extends TumiDomain{

	private EstadoPrevisionId	id;
	...
	public EstadoPrevision(){
		id = new EstadoPrevisionId();
	}
	
	public EstadoPrevisionId getId() {
		return id;
	}
	public void setId(EstadoPrevisionId id) {
		this.id = id;
	}
	...
	public String toString() {
		return "EstadoPrevision [id=" + id + ", intParaEstado=" + intParaEstado
