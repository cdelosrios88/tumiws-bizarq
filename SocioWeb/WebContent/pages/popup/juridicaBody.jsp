    ...
    <h:form id="frmPerJuriConve">
         	<h:panelGrid columns="3">
		        <a4j:commandButton value="Grabar" actionListener="#{perJuridicaController.savePerJuridicaEstructura}" styleClass="btnEstilos"
		        				reRender="pgRazonSocN1,pgRazonSocN2,pgRazonSocN3,mpMessage"
		        				oncomplete="if(#{perJuridicaController.isJuridicaSaved}){Richfaces.hideModalPanel('pAgregarPerJuri')}else{Richfaces.showModalPanel('mpMessage')}"/>												                 
