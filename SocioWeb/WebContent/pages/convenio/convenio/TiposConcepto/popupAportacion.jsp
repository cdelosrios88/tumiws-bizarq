...
<!-- Fecha     : 11/06/2012               -->
	...
	<h:form id="frmAportacion">
		<rich:extendedDataTable id="edtAportacion" value="#{convenioController.listaAportacionComp}" 
		...
		<a4j:commandButton id="btnSelectAportacion" value="Seleccionar" styleClass="btnEstilos" actionListener="#{convenioController.getListaAportaciones}" reRender="pgListAportaciones"
			oncomplete="Richfaces.hideModalPanel('panelAportacion')"/>
	</h:form>