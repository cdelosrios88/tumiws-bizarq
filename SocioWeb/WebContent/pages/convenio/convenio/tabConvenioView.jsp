...
<h:panelGrid id="pgFormHojaPlaneamiento">
	...
	<rich:panel style="width: 920px;border:1px solid #17356f;background-color:#DEEBF5;">
		...
		<rich:panel style="width: 890px;border:1px solid #17356f;background-color:#DEEBF5;">
	 	...
	 	<h:panelGrid id="pgRetenPlan" columns="6" border="0">
	 		<rich:column>
	 			<h:selectBooleanCheckbox value="#{hojaPlaneamientoController.chkRetencion}" disabled="true">
	         ...
	         <rich:column><h:outputText value="#{hojaPlaneamientoController.msgTipoRetencion}" styleClass="msgError"/></rich:column>
	         <rich:column><h:outputText value="#{hojaPlaneamientoController.msgRetencPlanilla}" styleClass="msgError"/></rich:column>
	 	</h:panelGrid>
