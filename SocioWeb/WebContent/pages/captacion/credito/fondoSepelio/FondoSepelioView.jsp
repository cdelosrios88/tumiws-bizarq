...
<%@ taglib uri="http://www.tumi.com.pe/tumi-h" prefix="tumih"%>
    ...
    <rich:panel rendered="#{fondoSepelioController.formFondoSepelioRendered}" style="width: 960px;border:1px solid #17356f;background-color:#DEEBF5;">
          	 	<h:panelGrid columns="5">
          	 		...
          	 		<rich:column>
	          	 		<h:inputText value="#{fondoSepelioController.beanCaptacion.strDescripcion}" size="80" disabled="true"/>
                    </rich:column>
          	 	...
          	 	<h:panelGrid id="pgRanFec" columns="5">
          	 		...
          	 		<rich:column>
	          	 		<h:selectOneRadio value="#{fondoSepelioController.rbFecIndeterm}" disabled="true">
          	 	...
          	 	<h:panelGrid columns="6">
          	 		...
          	 		<rich:column><h:outputText value=":"/></rich:column>
          	 		<rich:column>
          	 			<h:selectOneMenu value="#{fondoSepelioController.beanCaptacion.intParaTipopersonaCod}" disabled="true">
          	 		...
          	 		<rich:column>
          	 			<h:selectOneMenu value="#{fondoSepelioController.beanCaptacion.intParaRolPk}" disabled="true">
          	 	...
          	 	<h:panelGrid columns="4">
          	 		...
          	 		<rich:column><h:outputText value=":"/></rich:column>
          	 		<rich:column>
          	 			<h:selectOneRadio value="#{fondoSepelioController.rbCondicion}" disabled="true">
          	 	...
          	 	<h:panelGrid columns="4">
          	 		...
          	 		<rich:column><h:outputText value=":"/></rich:column>
          	 		<rich:column>
          	 			<h:selectOneMenu value="#{fondoSepelioController.beanCaptacion.intParaTipoDescuentoCod}" disabled="true">
          	 				<f:selectItem itemLabel="Seleccionar.." itemValue="0"/>
          	 	...
          	 	<h:panelGrid columns="4">
          	 		...
          	 		<rich:column><h:outputText value=":"/></rich:column>
          	 		<rich:column>
          	 			<h:selectOneMenu value="#{fondoSepelioController.beanCaptacion.intParaTipoConfiguracionCod}" disabled="true">
          	 				<f:selectItem itemLabel="Seleccionar.." itemValue="0"/>
          	 	...
          	 	<h:panelGrid id="pgValAportacion" columns="8">
          	 		...
          	 		<rich:column><h:outputText value=":"/></rich:column>
          	 		<rich:column>
          	 			<h:selectOneMenu value="#{fondoSepelioController.beanCaptacion.intParaMonedaCod}" disabled="true">
          	 				<f:selectItem itemLabel="Seleccionar.." itemValue="0"/>
          	 		...
          	 		<rich:column>
          	 			<h:selectOneRadio value="#{fondoSepelioController.strValAporte}" disabled="true">
          	 		...
          	 		<rich:column>
          	 			<h:inputText value="#{fondoSepelioController.beanCaptacion.bdValorConfiguracion}" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);" disabled="true" size="10"/>
          	 		</rich:column>
          	 		<rich:column>
          	 		...
          	 		<rich:column>
          	 			<h:selectOneMenu value="#{fondoSepelioController.beanCaptacion.intParaAplicacionCod}" disabled="true">
          	 	...
          	 	<h:panelGrid id="pgLimiteEdad" columns="5">
          	 		<rich:column>
          	 			<h:selectBooleanCheckbox value="#{fondoSepelioController.chkLimiteEdad}" disabled="true">
          	 		...
          	 		<rich:column>
          	 			<h:inputText value="#{fondoSepelioController.beanCaptacion.intEdadLimite}" onkeypress="return soloNumeros(event);" size="5" maxlength="2" disabled="true"/>
          	 		</rich:column>
          	 		<rich:column>
          	 	...
          	 	<h:panelGrid id="pgRequisitosBenef" columns="3">
          	 		...
          	 		<rich:column>
          	 			<h:panelGrid id="pgTiempoPresent" columns="4">
          	 				<rich:column>
          	 					<h:selectBooleanCheckbox value="#{fondoSepelioController.chkTiempoPresentSustento}" disabled="true">
		          	 		...
		          	 		<rich:column>
		          	 			<h:selectOneMenu value="#{fondoSepelioController.beanCaptacion.intTiempoSustento}" disabled="true">
          	 				...
          	 				<rich:column>
		          	 			<h:selectOneMenu value="#{fondoSepelioController.beanCaptacion.intParaTipoMaxMinSustCod}" disabled="true">
		                        	<f:selectItem itemLabel="Seleccione.." itemValue="0"/>
          	 			...
          	 			<h:panelGrid columns="2">
          	 				<rich:column>
          	 					<h:selectBooleanCheckbox value="#{fondoSepelioController.chkEscala}" disabled="true">
          	 	...
          	 	<h:panelGrid id="pgTipoBeneficiario" columns="2">
          	 		...
          	 		<rich:panel style="border:2px solid #17356f;border-bottom:none;background-color:#DEEBF5;width:725px;">
	          	 		<h:panelGrid columns="3">
		          	 		...
		          	 		<!--<rich:column>
		          	 			<h:selectOneMenu value="#{fondoSepelioController.intTipoBeneficiario}" disabled="true">
		          	 				<f:selectItem itemLabel="Seleccione.." itemValue="0"/>
          	 	...
          	 	<h:panelGrid id="pgCuotasCanc" columns="2">
          	 		...
          	 		<rich:panel style="border:2px solid #17356f;background-color:#DEEBF5;width:725px;">
	          	 		<h:panelGrid id="pgCuotasCancDet" columns="9">
	          	 			<rich:column>
	          	 				<h:outputText value="Cuotas canceladas"/>
	          	 			</rich:column>
		          	 		<rich:column>
		                        <h:selectOneMenu value="#{fondoSepelioController.intRangoCuota}" disabled="true">
		                            <f:selectItem itemLabel="Seleccionar.." itemValue="0"/>
	                        ...
	                        <rich:column>
	                            <h:inputText value="#{fondoSepelioController.intCuotaCancelada}" disabled="true" onkeypress="return soloNumeros(event);" size="5"/>
	                        </rich:column>
	                        <rich:column>
	                            <h:outputText value="Beneficio" />
	                        </rich:column>
	                        <rich:column>
	                            <h:inputText value="#{fondoSepelioController.bdBeneficio}" disabled="true" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);" size="5" maxlength="12"/>
	                        </rich:column>
	                        <rich:column>
	                            <h:outputText value="Gasto Adm."/>
	                        </rich:column>
	                        <rich:column>
	                            <h:inputText value="#{fondoSepelioController.bdGastoAdm}" disabled="true" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);" size="5" maxlength="12"/>%
	                        </rich:column>
		                    <rich:column>
		                        <a4j:commandButton value="Agregar" disabled="true" actionListener="#{fondoSepelioController.addReqVinculo}" styleClass="btnEstilos" reRender="pgTipoBeneficiario,pgCuotasCanc,pgReqVinculo"/>
		                    </rich:column>
		                    <rich:column>
		                    	<a4j:commandButton value="Eliminar" disabled="true" actionListener="#{fondoSepelioController.removeReqVinculo}" styleClass="btnEstilos" reRender="pgTipoBeneficiario,pgCuotasCanc,pgReqVinculo"/>
		                    </rich:column>
	                     </h:panelGrid>
                     </rich:panel>
          	 	</h:panelGrid>
          	 	...
          	 	<h:panelGrid id="pgReqVinculo" columns="2">
          	 		...
          	 		<rich:dataTable value="#{fondoSepelioController.listaRequisitos}"
	                	 ...
	                	 <rich:columnGroup rendered="#{item.intParaEstadoCod!=applicationScope.Constante.PARAM_T_ESTADOUNIVERSAL_ANULADO}">
				             ...
				             <rich:column>
	                       		<a4j:commandLink id="lnkQuitarRequisito" actionListener="#{fondoSepelioController.removeReqVinculo}" reRender="pgReqVinculo" disabled="true">
          	 	...
          	 	<h:panelGrid id="pgCeseBenef" columns="5">
          	 		<rich:column>
          	 			<h:selectBooleanCheckbox value="#{fondoSepelioController.chkCeseBeneficioMeses}" disabled="true">
          	 		...
          	 		<rich:column>
          	 			<h:inputText value="#{fondoSepelioController.beanCaptacion.intCeseBeneficio}" disabled="true" onkeypress="return soloNumeros(event);" size="5" maxlength="2"/>
          	 		</rich:column>
          	 	</h:panelGrid>
