...
<%@ taglib uri="http://www.tumi.com.pe/tumi-h" prefix="tumih"%>
    ...
    <rich:panel rendered="#{mantCuentaController.formMantCuentaRendered}" style="width: 960px;border:1px solid #17356f;background-color:#DEEBF5;">
          	 	<h:panelGrid columns="5">
          	 		...
          	 		<rich:column>
	          	 		<h:inputText value="#{mantCuentaController.beanCaptacion.strDescripcion}" size="80" disabled="true"/>
                    </rich:column>
          	 	...
          	 	<h:panelGrid id="pgRanFec" columns="5">
          	 		...
          	 		<rich:column>
	          	 		<h:selectOneRadio value="#{mantCuentaController.rbFecIndeterm}" disabled="true">
          	 	...
          	 	<h:panelGrid columns="6">
          	 		...
          	 		<rich:column><h:outputText value=":"/></rich:column>
          	 		<rich:column>
          	 			<h:selectOneMenu value="#{mantCuentaController.beanCaptacion.intParaTipopersonaCod}" disabled="true">
          	 		...
          	 		<rich:column>
          	 			<h:selectOneMenu value="#{mantCuentaController.beanCaptacion.intParaRolPk}" disabled="true">
          	 	...
          	 	<h:panelGrid columns="4">
          	 		...
          	 		<rich:column><h:outputText value=":"/></rich:column>
          	 		<rich:column>
          	 			<h:selectOneRadio value="#{mantCuentaController.rbCondicion}" disabled="true">
          	 	...
          	 	<h:panelGrid columns="4">
          	 		...
          	 		<rich:column><h:outputText value=":"/></rich:column>
          	 		<rich:column>
          	 			<h:selectOneMenu value="#{mantCuentaController.beanCaptacion.intParaCondicionLaboralCod}" disabled="true">
          	 	...
          	 	<h:panelGrid columns="4">
          	 		...
          	 		<rich:column><h:outputText value=":"/></rich:column>
          	 		<rich:column>
          	 			<h:selectOneMenu value="#{mantCuentaController.beanCaptacion.intParaTipoDescuentoCod}" disabled="true">
          	 				<f:selectItem itemLabel="Seleccionar.." itemValue="0"/>
          	 	...
          	 	<h:panelGrid columns="4">
          	 		...
          	 		<rich:column><h:outputText value=":"/></rich:column>
          	 		<rich:column>
          	 			<h:selectOneMenu value="#{mantCuentaController.beanCaptacion.intParaMonedaCod}" disabled="true">
          	 				<f:selectItem itemLabel="Seleccionar.." itemValue="0"/>
          	 	...
          	 	<h:panelGrid id="pgValAportacion" columns="8">
          	 		...
          	 		<rich:column><h:outputText value=":"/></rich:column>
          	 		<rich:column>
          	 			<h:selectOneMenu value="#{mantCuentaController.beanCaptacion.intParaTipoConfiguracionCod}" disabled="true">
          	 				<f:selectItem itemLabel="Seleccionar.." itemValue="0"/>
          	 		...
          	 		<rich:column>
          	 			<h:selectOneRadio value="#{mantCuentaController.strValAporte}" disabled="true">
          	 		...
          	 		<rich:column>
          	 			<h:inputText value="#{mantCuentaController.beanCaptacion.bdValorConfiguracion}" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);" disabled="true" size="10"/>
          	 		</rich:column>
          	 		<rich:column>
          	 			<h:inputText value="#{mantCuentaController.beanCaptacion.bdPorcConfiguracion}" onblur="extractNumber(this,4,false);" onkeyup="extractNumber(this,4,false);" disabled="true" size="10"/>
          	 		</rich:column>
          	 		<rich:column>
          	 			<h:selectOneMenu value="#{mantCuentaController.beanCaptacion.intParaAplicacionCod}" disabled="true">
          	 	...
          	 	<h:panelGrid id="pgCuentasConsideradas" columns="3">
          	 		...
          	 		<rich:column><h:outputText value=":"/></rich:column>
         	 			<rich:column>
          	 			<h:selectManyCheckbox value="#{mantCuentaController.lstCtasConsideradas}" layout="pageDirection" disabled="true">
          	 	...
          	 	<h:panelGrid id="pgProvision" columns="4">
          	 		...
          	 		<rich:column>
          	 			<h:selectBooleanCheckbox value="#{mantCuentaController.chkProvision}" disabled="true">
          	 	...
          	 	<h:panelGrid id="pgExtProvision" columns="4">
          	 		<rich:column width="150"></rich:column>
          	 		<rich:column>
          	 			<h:selectBooleanCheckbox value="#{mantCuentaController.chkExtProvision}" disabled="true">
          	 	...
          	 	<h:panelGrid id="pgCancelacion" columns="4">
          	 		<rich:column width="150"></rich:column>
          	 		<rich:column>
          	 			<h:selectBooleanCheckbox value="#{mantCuentaController.chkCancelacion}" disabled="true">
