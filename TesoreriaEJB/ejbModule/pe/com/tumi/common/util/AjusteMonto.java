...
public class AjusteMonto {
	...
	public static BigDecimal obtenerMontoAjustado(BigDecimal bdMonto) throws Exception{
		...
		//Autor: jchavez / Tarea: Modificación / Fecha: 14.08.2014 / Cambios en el calculo del redondeo, segun REUNION MOD TESORERIA 13.08.2014
//		if(modDecimales>0 && modDecimales <=2){
//			intDecimales = (intDecimales/10)*10;
//		}
		if(modDecimales>0 && modDecimales <=4){
			intDecimales = ((intDecimales/10)*10)+5;
		}
		if(modDecimales>5 && modDecimales <=9){
...
//		}
		...
		BigDecimal bdMontoAjustado = new BigDecimal(parteEntera+"."+(intDecimales<10?("0"+intDecimales):intDecimales));
