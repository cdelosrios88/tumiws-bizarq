...
@Remote
public interface PlanillaFacadeRemote { 
...
//	public List<ItemPlanilla> getPlanillaEnviada(SucursalId pk,Integer intTipoSocio,Integer pIntModalidadCod, 
//				Integer pIntEstadoCod, Integer periodoPlanilla,EstructuraId id) throws BusinessException;
  ...
  //AUTOR Y FECHA CREACION: JCHAVEZ / 14-09-2013
	...
	public List<PlanillaAdministra> getPlanillaPorIdEstructuraYTipoSocioYPeriodoCAS(EstructuraId pk,Integer intTipoSocio,Integer intPeriodo) throws BusinessException;
	//jchavez 19.06.2014
