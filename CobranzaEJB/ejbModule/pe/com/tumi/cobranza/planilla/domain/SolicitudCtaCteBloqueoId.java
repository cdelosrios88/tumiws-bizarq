...
public class SolicitudCtaCteBloqueoId extends TumiDomain{
	
	private Integer	intPersEmpresasolctacte;
	private Integer	intCcobItemsolctacte;
	private Integer	intTipoSolicitudctacte;
	private Integer intCcobItemblcu;
	...
	public Integer getIntTipoSolicitudctacte() {
		return intTipoSolicitudctacte;
	}
	public void setIntTipoSolicitudctacte(Integer intTipoSolicitudctacte) {
		this.intTipoSolicitudctacte = intTipoSolicitudctacte;
	}
	public Integer getIntCcobItemblcu() {
		return intCcobItemblcu;
	}
	public void setIntCcobItemblcu(Integer intCcobItemblcu) {
		this.intCcobItemblcu = intCcobItemblcu;
	}
