...
public class AutorizaPrevision extends TumiDomain{
	private AutorizaPrevisionId id;
	...
	public AutorizaPrevisionId getId() {
		return id;
	}
	public void setId(AutorizaPrevisionId id) {
		this.id = id;
	}
