...
<h:form>
   	<rich:panel styleClass="rich-tabcell-noborder" style="border:1px solid #17356f;">
        	...
        	<h:panelGrid columns="11">              	
            	...
            	<rich:column width="160">
					<h:selectOneMenu value="#{cierreFondosController.intTipoFondoFijo}" style="width: 150px;">
						<f:selectItem itemValue="0" itemLabel="Seleccionar"/>
						<tumih:selectItems var="sel" value="#{cierreFondosController.listaTipoFondoFijo}" 
            	...
            	<rich:column width="170">
					<h:selectOneMenu value="#{cierreFondosController.intIdSucursal}" disabled="#{cierreFondosController.blnDisabledSucursal}" style="width: 160px;">
						<f:selectItem itemValue="0" itemLabel="Seleccionar"/>
						<tumih:selectItems var="sel" value="#{cierreFondosController.listaSucursalBus}"
							itemValue="#{sel.intIdDetalle}" itemLabel="#{sel.strDescripcion}"/>
					</h:selectOneMenu>
            	</rich:column>
            	...
            	<rich:column width="90">
                	<h:selectOneMenu
						style="width: 90px;"
						value="#{cierreFondosController.intEstadoFondo}">
						<tumih:selectItems var="sel" cache="#{applicationScope.Constante.PARAM_T_ESTADOFONDO}" 
							itemValue="#{sel.intIdDetalle}" itemLabel="#{sel.strDescripcion}"
                    ...
                    <rich:column width="80px" style="text-align: center">
                  	...
                  	<rich:column width="80px" style="text-align: center">
                   		<a4j:commandLink
							...
							value="Anular Cierre"
					        actionListener="#{cierreFondosController.anular}"
							reRender="panelBotones,contPanelInferiorAnulacion">
							<f:attribute name="item" value="#{item}"/>
						</a4j:commandLink>
                  	</rich:column>
                   	<f:facet name="footer">
		...
		<h:panelGroup style="border: 0px solid #17356f;background-color:#DEEBF5;" styleClass="rich-tabcell-noborder"
			...
			<h:panelGrid columns="3">
				<a4j:commandButton value="Grabar" styleClass="btnEstilos" style="width:90px"
			    	...
			    	reRender="contPanelInferior,contPanelInferiorAnulacion,panelMensaje,panelBotones,panelTablaResultados"
			    ...
			    <a4j:commandButton value="Cancelar" styleClass="btnEstilos"style="width:90px"
			    	...
			    	reRender="contPanelInferior,contPanelInferiorAnulacion,panelMensaje,panelBotones"/>      
			</h:panelGrid>
		</h:panelGroup>
	...
	<h:panelGroup id="contPanelInferiorAnulacion">
				
			<rich:panel rendered="#{cierreFondosController.mostrarPanelInferiorAnulacion}"style="border:1px solid #17356f;background-color:#DEEBF5;">	 		
				...
				<h:panelGrid columns="2">
					...
					<rich:column width="200">
	                	<h:selectOneMenu value="#{cierreFondosController.intParaTipoAnulaFondo}" style="width: 200px;">
	                		<f:selectItem itemValue="0" itemLabel="Seleccionar"/>
				...
				<h:panelGroup rendered="#{!cierreFondosController.datosValidadosAnulacion}">
					
					<h:panelGrid columns="1">
						<rich:column width="820">
							<a4j:commandButton styleClass="btnEstilos"	
				               	value="Validar Datos" 
				               	reRender="contPanelInferiorAnulacion,panelBotones,panelMensaje"
				               	action="#{cierreFondosController.validarDatosAnulacion}" 
				               	style="width:820px"/>
						</rich:column>
					</h:panelGrid>
