	...
	<h:form>
	   	<h:panelGroup>	    	
	    	<h:panelGrid columns="12" id="panelPopUpBuscarPersona">
				...
				<rich:column width="100">
					<h:selectOneMenu
						value="#{fondosFijosController.intTipoPersona}"
						disabled="#{fondosFijosController.intTipoBuscarPersona==2}"
						style="width: 100px;">
				...
				<rich:column width="30">
           			<h:outputText  value="DNI :"
           				rendered="#{fondosFijosController.intTipoPersona==applicationScope.Constante.PARAM_T_TIPOPERSONA_NATURAL}"/>
           			<h:outputText  value="RUC :"
           				rendered="#{fondosFijosController.intTipoPersona==applicationScope.Constante.PARAM_T_TIPOPERSONA_JURIDICA}"/>
           		</rich:column>
           		<rich:column width="150">
           			<h:inputText size="20"
           				rendered="#{fondosFijosController.intTipoPersona==applicationScope.Constante.PARAM_T_TIPOPERSONA_NATURAL}"
           				onkeydown="return validarNumDocIdentidad(this,event,8)"
           				value="#{fondosFijosController.strFiltroTextoPersona}"/>
           			<h:inputText size="20"
           				rendered="#{fondosFijosController.intTipoPersona==applicationScope.Constante.PARAM_T_TIPOPERSONA_JURIDICA}"
           		...
           		<rich:column>
           			<a4j:commandButton styleClass="btnEstilos"
                    	...
                    	action="#{fondosFijosController.buscarPersona}" 
                    	style="width:100px"/>
           		</rich:column>
	    	</h:panelGrid>	    	
			...
			<h:panelGroup id="tablaPersona">
	    		<rich:dataTable
	    			var="item"
	                value="#{fondosFijosController.listaPersona}"
			  		rowKeyVar="rowKey"
			  		rows="5"
			  		sortMode="single" 
			  		width="520px">
					...
					<rich:column width="120" style="text-align: center;">
			        	...
			        	<a4j:commandLink 
			    			value="Seleccionar"
							actionListener="#{fondosFijosController.seleccionarPersona}"
							oncomplete="Richfaces.hideModalPanel('pBuscarPersona')"
							reRender="panelPersonaF,panelDocumentoF">
