...
<%@ taglib uri="http://www.tumi.com.pe/tumi-h" prefix="tumih"%>
	...
	<h:form id="frmSeleccionFondoCuenta">
	    	...
	    	<h:panelGrid columns="5">
         		...
         		<rich:column>
					<h:selectOneMenu id="SucursalCuenta" 
						...
						<a4j:support event="onchange" action="#{bancoFondoController.seleccionarSucursal}" reRender="frmSeleccionFondoCuenta"  />
					</h:selectOneMenu>
                </rich:column>
	    	</h:panelGrid>
	    		...
	    		<rich:column width="100">
           		...
           		<rich:column width="70">
                    <a4j:commandButton styleClass="btnEstilos"
						...
						style="width:70px">
						<f:attribute name="tipo" value="#{applicationScope.Constante.FONDOFIJOCUENTA}"/>
					</a4j:commandButton>
           		</rich:column>
	    	</h:panelGrid>
			...
			<h:panelGrid columns="2">
			    ...
			    <rich:column style="border:none" id="colBtnModificar">
			    	<a4j:commandButton value="Aceptar" styleClass="btnEstilos"
			    		action="#{bancoFondoController.aceptarSeleccionFondoCuenta}"
		        		oncomplete="if(#{bancoFondoController.mostrarMensajePopUp}){rendPopUp3();}else{Richfaces.hideModalPanel('pSeleccionCuentaContable');rendTabla3();}"/>
		        	<a4j:commandButton value="Cancelar" styleClass="btnEstilos"
		           		onclick="Richfaces.hideModalPanel('pSeleccionCuentaContable')"/>
			 	</rich:column>
			</h:panelGrid>
			<a4j:jsFunction name="rendTabla3" reRender="panelListaCuentaContable" ajaxSingle="true"/>
			<a4j:jsFunction name="rendPopUp3" reRender="frmSeleccionFondoCuenta" ajaxSingle="true"/>
	   	</h:panelGroup>
	</h:form>