...
<rich:modalPanel id="pAlertaRegistroC" width="360" height="120"
	    	...
	    	<h:panelGrid columns="4">
	    		...
	    		<rich:column style="border:none" width="110">
	    			<a4j:commandButton value="Ver" 
	    				...
	    				style="width:100px"	
            			action="#{contratoController.verRegistro}"
             			onclick="Richfaces.hideModalPanel('pAlertaRegistroC')"
             			reRender="contPanelInferiorC,panelBotonesC"/>
             	</rich:column>             	
             	<rich:column style="border:none" width="110">
        			<a4j:commandButton value="Eliminar"
        				rendered="#{contratoController.registroSeleccionado.intParaEstado == applicationScope.Constante.PARAM_T_ESTADOUNIVERSAL_ACTIVO}"
        				styleClass="btnEstilos"
        				style="width:100px"
            			action="#{contratoController.eliminarRegistro}"
             			onclick="Richfaces.hideModalPanel('pAlertaRegistroC')"
             			reRender="panelMensajeC,panelTablaResultadosC"/>
	        	</rich:column>
	    	</h:panelGrid>
    	</h:panelGroup>
    </h:form>
