...
<rich:modalPanel id="mpUpdateDelete" width="450" height="138"
	 	resizeable="false" style="background-color:#DEEBF5">
        <f:facet name="header">
            <h:panelGrid>
              <rich:column style="border: none;">
                <h:outputText value="Modificar/Eliminar" styleClass="tamanioLetra"></h:outputText>
              </rich:column>
            </h:panelGrid>
        </f:facet>
       ...
       <h:form id="formUpdateDelete">
       	<rich:panel style="border: 0px solid #17356f;background-color:#DEEBF5" >                 
         <h:panelGrid border="0">
             <h:outputText id="lblCodigo" value="Elija la opción que desea realizar..." styleClass="tamanioLetra"></h:outputText>
         </h:panelGrid>
         <rich:spacer height="16px"/>
         	<h:panelGrid columns="3" border="0" style="margin:0 auto; width: 100%">
              ...
              <a4j:commandButton value="Eliminar" styleClass="btnEstilos"
              					oncomplete="Richfaces.hideModalPanel('mpUpdateDelete'),deleteRow()"></a4j:commandButton>
          	</h:panelGrid>
            </rich:panel>
