	...
	<h:form id="frmSeleccionPersona">
	   	<h:panelGroup id="divSeleccionPersona" layout="block">
	    	...
	    	<h:panelGrid style="border-spacing:5px 0px; border-collapse:separate">
	    		<rich:columnGroup>
	    			<rich:column>
	    				<h:selectOneMenu value="#{tributacionController.intCboTipoPersonaBusq}" onchange="selecTipoPersona(#{applicationScope.Constante.ONCHANGE_VALUE})">
	    			...
	    			<rich:column>
	    				<h:selectOneMenu id="cboFiltroPersona" value="#{tributacionController.intCboFiltroPersonaBusq}" onchange="selecFiltroPersona(#{applicationScope.Constante.ONCHANGE_VALUE})">
	    					<f:selectItem itemValue="0" itemLabel="Seleccione.."/>
	    			...
	    			<rich:column>
	    				<a4j:commandButton action="#{tributacionController.buscarPersona2}" value="Buscar" 
