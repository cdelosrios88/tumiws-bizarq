	    		...
	    		<rich:column width="50">
             	...
             	<rich:column style="border:none" width="150">
        			<a4j:commandButton value="Aceptar"
        				...
        				style="width:100px"
            			action="#{controlLibroContableController.eliminarRegistro}"
             			reRender="mpBotonesLegalizacion,mpConfimarEliminacion,divTblLibroContable,divTblLegalizacion,divTblLegalizacionPeriodo"/>	   
             	...
             	<rich:column style="border:none" width="110">
        			<a4j:commandButton value="Cancelar"
        				styleClass="btnEstilos"
        				style="width:100px"
             			reRender="mpConfimarEliminacion"/>        		
	        	</rich:column>
	    	</h:panelGrid>
    	</h:panelGroup>
    </h:form>
