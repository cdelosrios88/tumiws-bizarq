...
<rich:modalPanel id="mpSeleccionPerdi" width="620" height="280"
	...
	<f:facet name="controls">
		<h:panelGroup>
			...
			<rich:componentControl for="mpSeleccionPerdi" attachTo="hideSeleccionRect"
				operation="hide" event="onclick" />
		</h:panelGroup>
	</f:facet>
	
	<h:form id="frmSeleccionPersonaPerdida">
	   	<h:panelGroup id="divSeleccionPersona" layout="block">
	    	
	    	<h:panelGrid style="border-spacing:5px 0px; border-collapse:separate">
	    		<rich:columnGroup>
	    			<rich:column>
	    				<h:selectOneMenu value="#{perdidasSiniestroController.intCboTipoPersonaBusq}" onchange="selecTipoPersona(#{applicationScope.Constante.ONCHANGE_VALUE})">
	    			...
	    			<rich:column>
	    				<h:selectOneMenu id="cboFiltroPersona" value="#{perdidasSiniestroController.intCboFiltroPersonaBusq}" onchange="selecFiltroPersona(#{applicationScope.Constante.ONCHANGE_VALUE})">
	    					<f:selectItem itemValue="0" itemLabel="Seleccione.."/>
	    					<f:selectItems value="#{perdidasSiniestroController.cboFiltroPersona}"/>
	    				</h:selectOneMenu>
	    			</rich:column>
	    			<rich:column>
	    				<h:inputText id="txtPersonaBusq" value="#{perdidasSiniestroController.strTxtPersonaBusq}" 
	    							 size="35"></h:inputText>
	    			</rich:column>
	    			<rich:column>
	    				<a4j:commandButton action="#{perdidasSiniestroController.buscarPersona}" value="Buscar" 
	    	...
	    	<h:panelGroup id="divTblPersona" layout="block" style="padding:15px">
	    		<rich:extendedDataTable id="tblPersona" enableContextMenu="false" style="margin:0 auto"
	                        var="item" value="#{perdidasSiniestroController.listaPersona}"
			            ...
			            <rich:column width="60">
							...
							<h:selectOneRadio onclick="seleccionarPersPerdido(this.value)">
