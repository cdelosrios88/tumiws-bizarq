	...
	<script language="JavaScript" src="/js/main.js"  type="text/javascript">
		...
		<rich:panel style="border: 0px solid #17356f;background-color:#DEEBF5;">
		       <h:panelGrid columns="3">
		           ...
		           <rich:column>
		            	<a4j:commandButton value="Buscar" actionListener="#{socioEstrucController.buscarSocioEstructura}"
		            		reRender="pgSocioEstructuraRef" styleClass="btnEstilos"/>
		           </rich:column>
	           </h:panelGrid>
           
           		<h:panelGrid id="pgSocioEstructuraRef">
	              <rich:extendedDataTable id="tblEntidadRef" enableContextMenu="false" onRowClick="seleccionarEntidad('#{rowKey}')"
					...
					<f:facet name="footer">   
			        	<rich:datascroller for="tblEntidadRef" maxPages="10"/>   
			        </f:facet>
	        ...
	        <h:panelGrid columns="2">
	         	<rich:column>
	         		<a4j:commandButton value="Seleccionar" actionListener="#{socioEstrucController.seleccionarEntidadRef}" 
	         			reRender="pgListCapacidadRefinan,pgErrors,pgMsgErrorEstructura"
						oncomplete="Richfaces.hideModalPanel('mpSocioEstructuraRef')" styleClass="btnEstilos"/>
	         	</rich:column>
	         	<rich:column>
