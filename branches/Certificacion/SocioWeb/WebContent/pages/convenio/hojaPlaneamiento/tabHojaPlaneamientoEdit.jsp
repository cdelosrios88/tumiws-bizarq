...
<%@ taglib uri="http://www.tumi.com.pe/tumi-h" prefix="tumih"%>
	...
	<rich:panel rendered="#{hojaPlaneamientoController.formHojaPlaneamientoRendered}" style="width: 970px;border:1px solid #17356f;background-color:#DEEBF5;">
		<h:outputText value="DATOS GENERALES"  style="font-weight:bold;"/>
		<rich:panel style="width: 950px;border:1px solid #17356f;background-color:#DEEBF5;">
	 	<h:panelGrid columns="6">
	 		...
	 		<rich:column style="padding-left:10px;">
		 		<h:selectOneRadio id="rbTipoConvenio" value="#{hojaPlaneamientoController.strTipoConvenio}" disabled="#{hojaPlaneamientoController.formTipoConvEnabled}">
	 	...
	 	<h:panelGrid columns="4">
	         ...
	         <rich:column style="padding-left:10px;">
				...
				<h:panelGroup rendered="#{hojaPlaneamientoController.strHojaPlaneamiento == applicationScope.Constante.MANTENIMIENTO_MODIFICAR}">
					<h:selectOneMenu value="#{hojaPlaneamientoController.beanAdenda.intParaEstadoHojaPlan}" disabled="false">
						<tumih:selectItems var="sel" cache="#{applicationScope.Constante.PARAM_T_ESTADODOCUMENTO}" 
						itemValue="#{sel.intIdDetalle}" itemLabel="#{sel.strDescripcion}"
						propertySort="intOrden"/>
					</h:selectOneMenu>
	 	...
	 	<h:panelGrid id="pgBusqEntidad" columns="3">
	 		...
	 		<rich:column style="padding-left:10px;">
	 			<a4j:commandButton value="Buscar" actionListener="#{hojaPlaneamientoController.listarEstructuras}"
	 				oncomplete="Richfaces.showModalPanel('panelEstructura').show()" reRender="pgBusqEntidad,pgListEstructHojaPlan,tbTablasMenu,panelEstructura" 
	         		disabled="#{hojaPlaneamientoController.btnBuscarEnabled}" styleClass="btnEstilos"/>
	         </rich:column>
	 	</h:panelGrid>
	 	
	 	<h:panelGrid id="pgListEstructHojaPlan" columns="2">
	 		<rich:column width="160"/>
	 		<rich:column>
		 		<rich:dataTable id="tbEstructHojaPlan" value="#{hojaPlaneamientoController.listaConvEstructuraDetComp}"
	               	var="item" rowKeyVar="rowKey" sortMode="single" rendered="#{not empty hojaPlaneamientoController.listaConvEstructuraDetComp}">
	               	<f:facet name="header">
			      		<rich:columnGroup>
			      	...
			      	<rich:columnGroup rendered="#{item.convenioEstructuraDetalle.intParaEstadoCod!=applicationScope.Constante.PARAM_T_ESTADOUNIVERSAL_ANULADO}">
			      		<rich:column width="15px">
		               	...
		               	<rich:column>
		               		<a4j:commandLink id="lnkQuitarEstructura"
		               			onclick="if(!confirm('Está Ud. Seguro de Eliminar este Registro?'))return false;" 
		               			actionListener="#{hojaPlaneamientoController.removeConvenioEstructuraDet}" reRender="pgListEstructHojaPlan">
		   						<f:param name="rowKeyConvEstructDet" value="#{rowKey}"></f:param>
		   						<h:graphicImage value="/images/icons/delete.png" alt="delete"/>
		   						<rich:toolTip for="lnkQuitarEstructura" value="Quitar" followMouse="true"/>
		   					</a4j:commandLink>
		               	</rich:column>
			      	</rich:columnGroup>
		        </rich:dataTable>
	 		...
	 		<%--
	 		<rich:dataTable id="tbEstructHojaPlan" value="#{hojaPlaneamientoController.listaConvEstructuraDetComp}" rows="5"
	               	var="item" rowKeyVar="rowKey" sortMode="single" rendered="#{not empty hojaPlaneamientoController.listaConvEstructuraDetComp}">
	      	<f:facet name="header">
	      		<rich:columnGroup>
	      			<rich:column><rich:spacer/></rich:column>
	      	...
	      	<rich:columnGroup rendered="#{item.convenioEstructuraDetalle.intParaEstadoCod!=applicationScope.Constante.PARAM_T_ESTADOUNIVERSAL_ANULADO}">
		        ...
		        <rich:column>
		        	<a4j:commandLink id="lnkQuitarConvEstDet" actionListener="#{hojaPlaneamientoController.removeConvenioEstructuraDet}" reRender="pgEstructHojaPlan">
   						<f:param name="rowKeyConvEstructDet" value="#{rowKey}"></f:param>
   						<h:graphicImage value="/images/icons/delete.png" alt="delete"/>
	 	...
	 	<h:panelGrid columns="3">
	 		...
	 		<rich:column><h:outputText value=":"/></rich:column>
	 		<rich:column style="padding-left:10px;">
		 		<h:selectOneMenu id="idCboSucursal" value="#{hojaPlaneamientoController.beanAdenda.intSeguSucursalPk}">
	 	...
	 	<h:panelGrid columns="1" border="0">
	 		<rich:column style="padding-left:355px;">
		 		<h:selectOneRadio id="rbOpcionFiltro" value="#{hojaPlaneamientoController.beanAdenda.intOpcionFiltroCredito}">
	 	...
	 	<h:panelGrid id="pgRetenPlan" columns="3" border="0">
	 		...
	 		<rich:column>
		 		<h:selectOneRadio value="#{hojaPlaneamientoController.beanAdenda.intParaTipoRetencionCod}">
		 			<tumih:selectItems var="sel" cache="#{applicationScope.Constante.PARAM_T_TIPORETENCION}" 
						itemValue="#{sel.intIdDetalle}" itemLabel="#{sel.strDescripcion}"
						propertySort="intOrden"/>
	          	</h:selectOneRadio>
	        </rich:column>
	        <rich:column><h:inputText size="10" value="#{hojaPlaneamientoController.beanAdenda.bdRetencion}" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);" onkeypress="return blockNonNumbers(this, event, true, false);"/></rich:column>
	 	</h:panelGrid>
	 	
	 	<h:panelGrid columns="4" border="0">
	 		<rich:column>
	 			<h:selectBooleanCheckbox value="#{hojaPlaneamientoController.beanAdenda.boCartaAutorizacion}"/>
	 		</rich:column>
	 		<rich:column><h:outputText value="Carta de Autorización"/></rich:column>
	 		<rich:column style="padding-left:20px;">
	 			<h:selectBooleanCheckbox value="#{hojaPlaneamientoController.beanAdenda.boDonacion}"/>
	 		</rich:column>
		...
		<rich:panel style="width: 950px;border:1px solid #17356f;background-color:#DEEBF5;">
				...
				<rich:dataTable var="item" rowKeyVar="rowKey" width="300px"
	 				...
	 				<f:facet name="header">
						...
						<rich:columnGroup rendered="#{item.intParaEstadoCod!=applicationScope.Constante.PARAM_T_ESTADOUNIVERSAL_ANULADO}">
				                   ...
				                   <rich:column>
				                       <h:inputTextarea cols="50" rows="5" value="#{item.strDescripcion}"/>
				                   </rich:column>
				                   ...
				                   <rich:column width="80px">
										...
										<h:outputText value="--------"/>
										<h:inputHidden value="#{item.listaPoblacionDetalle[2].id.intTipoSocio}"/>
										<%--
				                   ...
				                   <rich:column width="60px">
				                       ...
				                       <h:inputText value="#{item.listaPoblacionDetalle[0].intPadron}" size="5" onkeydown="return validarEnteros(event);"/>
				                       <h:inputText value="#{item.listaPoblacionDetalle[1].intPadron}" size="5" onkeydown="return validarEnteros(event);"/>
				                       <h:inputText value="#{item.listaPoblacionDetalle[2].intPadron}" size="5" onkeydown="return validarEnteros(event);"/>
				                   </rich:column>
				                   <rich:column width="280px">
				                       <h:inputTextarea cols="50" rows="5" value="#{item.bdDistancia}" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);" style="text-align:center"/>
				                   </rich:column>
				                   <rich:column>
						           		<a4j:commandLink id="lnkQuitarPoblacion" actionListener="#{hojaPlaneamientoController.removePoblacion}" reRender="pLstPoblacion">
			...
			<h:panelGrid columns="3">
				...
				<a4j:commandButton value="Calcular" styleClass="btnEstilos" actionListener="#{hojaPlaneamientoController.calcularPoblacion}" reRender="pLstResumenPob"/>
					...
					<rich:columnGroup rendered="#{item.intParaEstadoCod!=applicationScope.Constante.PARAM_T_ESTADOUNIVERSAL_ANULADO}">
						<rich:column width="20">
	                  	...
	                  	<rich:column width="260px">
	                      	<h:inputText value="#{item.strDescripcionEntidad}" size="45"/>
	                  	</rich:column>
	                  	<rich:column width="80px">
	                      	<h:inputText value="#{item.intCantidad}" size="9" onkeydown="return validarEnteros(event);"/>
	                  	</rich:column>
	                  	<rich:column width="140px">
	                      	<h:inputText value="#{item.bdPlazoPrestamo}" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);" onkeypress="return blockNonNumbers(this, event, true, false);"/>
	                  	</rich:column>
	                  	<rich:column width="80">
	                      	<h:inputText value="#{item.bdTasaPrestamo}" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);" onkeypress="return blockNonNumbers(this, event, true, false);" size="9"/>
	                  	</rich:column>
	                  	<rich:column width="115">
	                      	<h:inputText value="#{item.bdAporte}" onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);" onkeypress="return blockNonNumbers(this, event, true, false);" size="14"/>
	                  	</rich:column>
	                  	<rich:column width="140px">
	                      	<h:inputText value="#{item.strServicio}" size="14"/>
	                  	</rich:column>
	                  	<rich:column>
	                  		<a4j:commandLink id="lnkQuitarCompetencia" actionListener="#{hojaPlaneamientoController.removeCompetencia}" reRender="pLstCompetencia">
