     	...
     	<rich:panel style="border: 2px solid #17356f;background-color:#DEEBF5;width:750px;height:158px">
			...
			<h:panelGroup id="divTiposComunicacion" style="border:1px; solid #17356f;width:700px; background-color:#DEEBF5">
					...
					<h:panelGrid id="pgFormComunic1" columns="7">
						<rich:column style="border:none">
						  	<h:selectOneMenu value="#{comunicacionController.beanComunicacion.intSubTipoComunicacionCod}" styleClass="SelectOption2" style="width:140px">
						  		<f:selectItem itemLabel="Seleccione.." itemValue="0"/>
								<tumih:selectItems var="sel" cache="#{applicationScope.Constante.PARAM_T_TIPO_TELEFONO}" 
									itemValue="#{sel.intIdDetalle}" itemLabel="#{sel.strDescripcion}"/>
							</h:selectOneMenu>
						</rich:column>
						...
						<rich:column style="border:none;">
							<h:inputText id="Numero" value="#{comunicacionController.beanComunicacion.intNumero}" onkeydown="return validarEnteros(event);" size="15">
						...
						<rich:column style="border:none;padding-left:10px;">
							<h:inputText value="#{comunicacionController.beanComunicacion.intAnexo}" onkeydown="return validarEnteros(event);" size="15" maxlength="5"/>
						</rich:column>
					</h:panelGrid>
				...
				<h:panelGrid id="pgEmail" columns="3" rendered="#{comunicacionController.renderEmail}">
					...
					<rich:column style="border:none">
						<h:selectOneMenu value="#{comunicacionController.beanComunicacion.intSubTipoComunicacionCod}" style="width:140px">
							<f:selectItem itemLabel="Seleccione.." itemValue="0"/>
					...
					<rich:column style="border:none">
						<h:inputText id="txtEmail" size="80" value="#{comunicacionController.strEmail}">
						</h:inputText>
					</rich:column>
				</h:panelGrid>
				...
				<h:panelGrid id="pgPagWeb" columns="3" rendered="#{comunicacionController.renderWebSite}">
					...
					<rich:column style="border:none;">
						<h:inputText id="txtWeb" value="#{comunicacionController.strWeb}" size="80"/>
					</rich:column>
				</h:panelGrid>
	        </h:panelGroup>
