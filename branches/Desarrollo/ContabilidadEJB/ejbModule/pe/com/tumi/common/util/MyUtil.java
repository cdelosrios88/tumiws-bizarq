...
public class MyUtil {
	...
	public static Integer	obtenerMesActual() throws Exception{
	...
	public static Integer	obtenerPeriodoActual(Integer intMes) throws Exception{
		String strPeriodo = "";
		Calendar cal = Calendar.getInstance();
		int año = cal.get(Calendar.YEAR);
		if(intMes<10){
			strPeriodo = año + "0" + intMes;
		}else{
			strPeriodo  = año + "" + intMes;
		}		
		return Integer.parseInt(strPeriodo);		
	}
