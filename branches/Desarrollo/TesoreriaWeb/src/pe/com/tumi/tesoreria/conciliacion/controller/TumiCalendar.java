...
* Resumen.
* Objeto: TumiCalendar
* Descripción:  Clase utilitaria contendrá los días útiles y demás de la Cooperativa El Tumi
...
/**
 * @Project : Conciliacion Bancaria The <code>TumiCalendar</code> extends
 *          GregorianCalendar
 * @author : Bizarq Technologies
 * @Creation_Date : Nov 5, 2014
 * @version 1.1
 */
public class TumiCalendar extends GregorianCalendar {
	 ...
	 *            <code>Date</code>
	 */
	public TumiCalendar(Date objDt) {
		setDtTime(objDt);
		toSetCavaliCalendar();
	}
	 ...
	 */
	public void toSetCavaliCalendar() {
