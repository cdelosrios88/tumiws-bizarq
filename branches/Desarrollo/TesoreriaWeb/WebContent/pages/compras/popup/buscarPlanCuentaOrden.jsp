...
<rich:modalPanel id="pBuscarPlanCuentaOrden" width="730" height="290"
    ...
    <f:facet name="controls">
        <h:panelGroup>
           <h:graphicImage value="/images/icons/remove_20.png" styleClass="hidelink">
           		<rich:componentControl for="pBuscarPlanCuentaOrden" operation="hide" event="onclick"/>
           </h:graphicImage>
       </h:panelGroup>
    </f:facet>	
	    	...
	    	<h:panelGrid columns="5" id="panelBuscarPC">
	    			<rich:column width="120">
	    				<h:selectOneMenu style="width: 120px;" 
	    					value="#{ordenController.planCuentaFiltro.intTipoBusqueda}">
	    			...
	    			<rich:column>
           			...
           			<rich:column width="100">
           				<h:selectOneMenu style="width: 100px;" 
           					disabled="true"
           					value="#{ordenController.planCuentaFiltro.id.intPeriodoCuenta}">
           					<f:selectItem itemValue="0" itemLabel="Todos"/>
           					<tumih:selectItems var="sel"
								value="#{ordenController.listaAnios}" 
								itemValue="#{sel.intIdDetalle}" 
								itemLabel="#{sel.strDescripcion}"/>
           				</h:selectOneMenu>
           			</rich:column>
	    			<rich:column>
	    				<h:inputText
	    					value="#{ordenController.planCuentaFiltro.strComentario}"
	    					size="45"/>
	    			</rich:column>
	    			<rich:column>
	    				<a4j:commandButton action="#{ordenController.buscarPlanCuenta}" 
	    					value="Buscar" 
	    					reRender="tablaBuscarPlanCuentaOrden" 
	    					styleClass="btnEstilos">
	    				</a4j:commandButton>
	    			</rich:column>	    		
	    	</h:panelGrid>
		    	
	    	<h:panelGroup id="tablaBuscarPlanCuentaOrden">
	    		<rich:dataTable id="tblSeleccionCuenta" 
	    			var="item" 
	                value="#{ordenController.listaPlanCuenta}" 
			  		rowKeyVar="rowKey" 
			  		rows="5" 
			  		sortMode="single" 
			  		width="710px">
					...
					<rich:column width="100" style="text-align: center">
						...
						<a4j:commandLink
							value="Seleccionar"
							actionListener="#{ordenController.seleccionarPlanCuenta}" 
							reRender="panelCuentaContableOD" 
							oncomplete="Richfaces.hideModalPanel('pBuscarPlanCuentaOrden')">
