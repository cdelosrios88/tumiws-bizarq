    	...
    	<rich:panel style="border:0px solid #17356f;background-color:#DEEBF5;width:920px;">
    		...
    		<h:panelGrid columns="3">
    			...
    			<rich:column>
    				...
    				oncomplete="{Richfaces.hideModalPanel('mpCapacidadCreditoRef')}" />
    			</rich:column>
    		</h:panelGrid>
    		
    		<rich:panel style="border: 2px solid #17356f;background-color:#DEEBF5;width:900px;">
    			...
    			<h:panelGrid columns="2">
    				<h:selectBooleanCheckbox value="#{capacidadPagoController.blnChkCartaAutorizacion}"
    					disabled="#{solicitudRefinanController.blnEsMINSA}">
    			...
    			<h:panelGrid id="pgListCapacidadDscto" columns="2">
    				...
    				<rich:column>
	    				<rich:dataTable var="item" rowKeyVar="rowKey" sortMode="single" width="300px"
	    					...
	    					<rich:column>
	    						<a4j:commandLink id="lnkDeleteCapacDscto" styleClass="no-decor" reRender="pgListCapacidadDscto,pgDsctosVarios,pgTotalEntidades"
				            		actionListener="#{capacidadPagoController.removeCapacidadDscto}"
    			...
    			<h:panelGrid columns="1">
    				<rich:column>
    					<a4j:commandButton value="Calcular" actionListener="#{capacidadPagoController.calcularCapacidadPagoRefinan}" styleClass="btnEstilos" reRender="pgBaseTotYDsctos,pgTotalEntidades,pgCapacPagoCas,pgDsctosVarios"/>
    				</rich:column>
    			</h:panelGrid>
    			
    			<h:panelGrid id="pgCapacPagoCas" columns="4">
    				<rich:column width="220px">
    					<h:outputText value="Capacidad de Pago - CAS" style="font-weight:bold;"/>
    				</rich:column>
    				<rich:column>
    					<h:outputText value=":"/>
    				</rich:column>
