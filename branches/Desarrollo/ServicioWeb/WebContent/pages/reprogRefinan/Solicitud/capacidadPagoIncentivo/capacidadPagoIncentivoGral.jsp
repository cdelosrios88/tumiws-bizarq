...
<%@ taglib uri="http://www.tumi.com.pe/tumi-h" prefix="tumih"%>
	...
	<script type="text/javascript">
   		...
   		<rich:panel id="pIncentivoGral" rendered="#{capacidadPagoController.blnFormTipoIncentivoGral}" style="border: 2px solid #17356f;background-color:#DEEBF5;width:900px;">
   			...
   			<h:panelGrid columns="4">
   				<rich:column width="220px">
   					<h:outputText value="C.- Base del Cálculo" style="font-weight:bold;"/>
   				</rich:column>
   				<rich:column>
   					<h:outputText value=":"/>
   				</rich:column>
   			...
   			<h:panelGrid id="pgIndiceDscto" columns="4">
   				<rich:column width="220px">
   					<h:outputText value="D.- Índice de Descuento" style="font-weight:bold;"/>
   				</rich:column>
   				<rich:column>
   					<h:outputText value=":"/>
   				</rich:column>
   				...
   				<rich:column>
   					<h:outputText value="% Según Dependencia"/>
   				</rich:column>
   			</h:panelGrid>
   			
   			<h:panelGrid columns="1">
   				<rich:column>
   					<a4j:commandButton value="Calcular" actionListener="#{capacidadPagoController.calcularPagoIncentGralRefinan}" styleClass="btnEstilos" reRender="pgCapacidadPago"/>
   				</rich:column>
   			</h:panelGrid>
