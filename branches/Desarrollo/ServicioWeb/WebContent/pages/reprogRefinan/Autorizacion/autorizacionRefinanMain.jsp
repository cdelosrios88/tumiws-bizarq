	...
	<rich:panel style="border: 0px solid #17356f;background-color:#DEEBF5;">
		...
		<h:panelGrid id="pgBusq2" columns="9" border="0">
			...
			<rich:column>
				...
				<h:selectOneMenu value="#{autorizacionRefinanController.intBusqEstado}" style="width: 120px;">
					<f:selectItem itemValue="0" itemLabel="Seleccione..." />
					<tumih:selectItems var="sel" value="#{autorizacionRefinanController.listaEstadoSolicitud}"
						itemValue="#{sel.intIdDetalle}" itemLabel="#{sel.strDescripcion}"
						propertySort="intOrden" />
				</h:selectOneMenu>
			</rich:column>
