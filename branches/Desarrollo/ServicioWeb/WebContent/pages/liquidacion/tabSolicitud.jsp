...
<h:form>
	<h:outputText value="#{solicitudLiquidacionController.inicioPage}"/>	
   	<rich:panel styleClass="rich-tabcell-noborder" style="border:1px solid #17356f;">
        ...
        <h:panelGrid id="pgTitulo" style="margin:0 auto; margin-bottom:10px">
   			<rich:column>
   				<h:outputText value="INGRESO DE SOLICITUD DE LIQUIDACIÓN" styleClass="tagTitulo"/>
   			</rich:column>
    	</h:panelGrid>
		...
		<h:panelGrid id="pgBusq3" columns="11" border="0">
			<rich:column colspan="9" width="1090px">
			</rich:column>
			<rich:column>
				<a4j:commandButton 
					value="Buscar" 
					actionListener="#{solicitudLiquidacionController.listarSolicitudLiquidacion}" 
					styleClass="btnEstilos" 
					reRender="panelSolicitudTablaResultados"/>
			</rich:column>
			<rich:column>
				<a4j:commandButton 
					value="Limpiar" 
					action="#{solicitudLiquidacionController.limpiarFiltros}" 
					styleClass="btnEstilos" 
					reRender="pgBusq1,pgBusq2,panelSolicitudTablaResultados"/>
			</rich:column> 
		</h:panelGrid>
        ...
        <h:panelGrid id="divPanelControlLiquidacion" columns="11"> 
			...
			<a4j:commandButton value="Guardar" actionListener="#{solicitudLiquidacionController.grabarSolicitud}" styleClass="btnEstilos"
								reRender="divFormLiquidacion, pgSolicitudLiquidacion,pgMsgErrorInicial"/>
			<a4j:commandButton value="Cancelar" action="#{solicitudLiquidacionController.cancelarGrabarSolicitud}" styleClass="btnEstilos"
			...
			<rich:column colspan="6" width="730px">
			</rich:column>
			<rich:column width="200px" style="margin-left: auto; margin-right: auto">
				...
				reRender="pgFormEnBlanco,frmEnBlanco"/>
		</h:panelGrid>
					...
					<h:panelGroup layout="block" rendered="#{solicitudLiquidacionController.blnShowValidarDatos}">
						...
						<h:panelGrid style="width: 100%">
							<a4j:commandButton value="Validar Datos" styleClass="btnEstilos1" style="width: 100%" 
								action="#{solicitudLiquidacionController.validarDatos}" reRender="divFormLiquidacion"/>
						</h:panelGrid>
						
						<rich:spacer height="10"></rich:spacer>
						
						<h:panelGrid id="pgMsgErrorValidarDatos">
							<h:outputText value="#{solicitudLiquidacionController.strMsgErrorValidarDatos}" styleClass="msgErrorValidacion"/>
						</h:panelGrid>
