...
<h:panelGroup rendered="#{solicitudPrestamoController.strSolicitudPrestamo == applicationScope.Constante.MANTENIMIENTO_NINGUNO}">
	<rich:panel rendered="#{solicitudPrestamoController.formSolicitudPrestamoRendered}" style="width:960px;border:1px solid #17356f;background-color:#DEEBF5;">
		...
		<h:panelGroup id="pgDatosSocioView" rendered="#{solicitudPrestamoController.blnDatosSocio}" layout="block">
			...
			<h:panelGrid id="pgListCapacidadCreditoView">
			...
			<h:panelGrid id="pgMsgErrorEstructuraView">
			...
			<rich:spacer height="10"></rich:spacer>
				...
				<rich:column>
	              ...
	              <rich:dataTable id="pgListSaldoCuentasView" value="#{solicitudPrestamoController.beanSocioComp.cuentaComp}" var="itemCuentaComp"
			...
			<h:panelGrid columns="7" id="pgOperacionView">
				<rich:column width="120px">
				...
				<rich:column>
					<h:inputText id="idMontoSolicitadoView" value="#{solicitudPrestamoController.beanExpedienteCredito.bdMontoSolicitado}" size="20" 
			...
			<h:panelGrid id="pgMsgErrorEvaluacionView">
			...
			<h:panelGrid id="pgRequisitosView" columns="10">
				<rich:column width="120px">
			...
			<h:panelGrid id="pgEvaluacionView" rendered="#{solicitudPrestamoController.blnEvaluacionCredito}">
				<h:panelGrid id="pgPrestamoView1" columns="11">
					<rich:column width="120px">
				...
				<h:panelGrid id="pgPrestamoView2" columns="11">
					<rich:column width="120px">
				...
				<h:panelGrid id="pgListGarantesSolidariosView" columns="2" rendered="#{not empty solicitudPrestamoController.listaGarantiaCreditoComp}">
					<rich:column width="130px"/>
					<rich:column>
						<rich:dataTable value="#{solicitudPrestamoController.listaGarantiaCreditoComp}" id="dTblGarantiasView"
				...
				<h:panelGrid id="pgCondicionesView" columns="3">
					<rich:column width="120px">
				...
				<h:panelGrid id="pgListDocAdjuntosView" columns="3">
					<rich:column width="120px">
							...
							<rich:dataGrid value="#{solicitudPrestamoController.listaRequisitoCreditoComp}" 
				                ...
				                <rich:panel id="infoDocAdjunto">
				                    <h:panelGrid columns="2">
										...
										<rich:column rendered="#{not empty itemRequisitos.archivoAdjunto.strNombrearchivo}">
											<h:commandLink value=" Descargar" 
												action="#{solicitudPrestamoController.descargaArchivoUltimo}" 
												style="color:black;padding-left: 5px;">
													
												<f:param name="strRutaActual" 
													value="#{itemRequisitos.archivoAdjunto.rutaActual}"/>
