...
<!-- Fecha     : 11/06/2012               -->
	...
	<h:form id="frmFondoRetiro">
		<rich:extendedDataTable id="edtAportacion" value="#{convenioController.listaFondoRetiroComp}" 
		...
		<a4j:commandButton id="btnSelectFondoRetiro" value="Seleccionar" styleClass="btnEstilos" actionListener="#{convenioController.getListaFondoRetiro}" reRender="pgListFondoRetiro"
		oncomplete="Richfaces.hideModalPanel('panelFondoRetiro')"/>
	</h:form>