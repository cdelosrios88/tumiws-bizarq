...
<a4j:include viewId="/pages/legalizacion/popup/popConfirmarEliminar.jsp" />

<rich:modalPanel id="mpBotonesLegalizacion" width="360" height="135"
    ...
    <f:facet name="controls">
        <h:panelGroup>
           <h:graphicImage value="/images/icons/remove_20.png" styleClass="hidelink">
           		<rich:componentControl for="mpBotonesLegalizacion" operation="hide" event="onclick"/>
           </h:graphicImage>
       </h:panelGroup>
    </f:facet>
    <h:form id="formBotonesLegalizacion">
    	<h:panelGroup style="background-color:#DEEBF5">
	    	...
	    	<h:panelGrid columns="4" id="pgBotonesLegalizacion">
	    		<rich:column width="50">
             	...
             	<rich:column style="border:none" width="110" rendered="#{controlLibroContableController.btnModificar}">
        			<a4j:commandButton value="Modificar"
        				...
        				style="width:100px"
            			action="#{controlLibroContableController.modificarValoresLegal}" 
             			oncomplete="Richfaces.showModalPanel('mpLegalizacionAgregar')" 
             			reRender="mpBotonesLegalizacion,divLegalizacionAgregar"/>
             	...
             	<rich:column style="border:none" width="110" rendered="#{controlLibroContableController.btnEliminar}">
        			<a4j:commandButton value="Eliminar"
            			...
            			reRender="pgBotonesLegalizacion"/>
	        	</rich:column>
