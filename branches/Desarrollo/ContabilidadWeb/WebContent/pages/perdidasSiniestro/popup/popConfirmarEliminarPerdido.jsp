...
<rich:modalPanel id="mpConfimarEliPerdido" width="360" height="180"
    ...
    <f:facet name="controls">
        <h:panelGroup>
           <h:graphicImage value="/images/icons/remove_20.png" styleClass="hidelink">
           		<rich:componentControl for="mpConfimarEliPerdido" operation="hide" event="onclick"/>
           </h:graphicImage>
       </h:panelGroup>
    </f:facet>
    <h:form>
	    		...
	    		<rich:column width="50">
             	...
             	<rich:column style="border:none" width="150">
        			<a4j:commandButton value="Aceptar"
        				...
        				style="width:100px"
            			action="#{perdidasSiniestroController.eliminarRegistro}"
             			reRender="mpModificarPerdido,mpConfimarEliPerdido,frmPerdidas"/>	   
             	...
             	<rich:column style="border:none" width="110">
        			<a4j:commandButton value="Cancelar"
        				styleClass="btnEstilos"
        				style="width:100px"
             			reRender="mpModificarPerdido,mpConfimarEliPerdido"/>        		
	        	</rich:column>
	    	</h:panelGrid>
    	</h:panelGroup>
    </h:form>
